import { al as BaseError$2, am as size$2, an as assertSize$2, ao as pad$2, ap as isHex, aq as numberToHex, ar as toHex, as as LruMap$1, at as SliceOffsetOutOfBoundsError$1, au as padHex, av as boolToHex, aw as IntegerOutOfRangeError$1, ax as stringToHex, ay as bytesToHex$1, az as hexToNumber$1, aA as trim$1, aB as InvalidBytesBooleanError$1, aC as hexToBigInt, aD as stringify$1, aE as formatUnits, aF as etherUnits, aG as formatGwei, aH as getContractAddress, aI as InternalRpcError, aJ as RpcRequestError, aK as ExecutionRevertedError, aL as FeeCapTooHighError, aM as FeeCapTooLowError, aN as NonceTooHighError, aO as NonceTooLowError, aP as NonceMaxValueError, aQ as InsufficientFundsError, aR as IntrinsicGasTooHighError, aS as IntrinsicGasTooLowError, aT as TransactionTypeNotSupportedError, aU as TipAboveFeeCapError, aV as UnknownNodeError, aW as InvalidBytesLengthError, aX as createBatchScheduler, aY as multicall3Abi, aZ as wait, a_ as InvalidInputRpcError, a$ as uid, b0 as batchGatewayAbi, b1 as addressResolverAbi, b2 as universalResolverResolveAbi, b3 as textResolverAbi, b4 as universalResolverReverseAbi, b5 as getUrl, b6 as HttpRequestError, b7 as hexToBool, b8 as erc1271Abi, b9 as erc6492SignatureValidatorAbi, ba as withResolvers, bb as withRetry } from "./walletconnect-BVoLvI4P.js";
import { bn, bm, bo, bp, bq, bj, br, bs, bt, bu, bv, bw, bx, by, bz, bA, bB, bC, bi, bk, bD, bl, bE, bF, bG, bH, bI, bJ, bK, bM, bL, bc, bg, bd, bh, bf, bN, be, bO } from "./walletconnect-BVoLvI4P.js";
import { fY as keccak_256, bM as __vitePreload, fZ as sha256$1, f_ as anumber, f$ as randomBytes, g0 as hmac, g1 as concatBytes$2, g2 as sha256$2 } from "./index-73GArslZ.js";
...
let InvalidArrayError$1 = class InvalidArrayError extends BaseError$2 {
  constructor(value) {
...
const hash = (value) => keccak256$1(toBytes(value));
...
let NegativeOffsetError$1 = class NegativeOffsetError extends BaseError$2 {
  constructor({ offset }) {
...
let PositionOutOfBoundsError$1 = class PositionOutOfBoundsError extends BaseError$2 {
  constructor({ length, position }) {
    super(`Position \`${position}\` is out of bounds (\`0 < position < ${length}\`).`, { name: "PositionOutOfBoundsError" });
  }
};
let RecursiveReadLimitExceededError$1 = class RecursiveReadLimitExceededError extends BaseError$2 {
...
function toBlobs(parameters) {
  ...
  return blobs.map((x) => bytesToHex$1(x.bytes));
}
...
async function call(client, args) {
  ...
  try {
    ...
    const { offchainLookup: offchainLookup2, offchainLookupSignature: offchainLookupSignature2 } = await __vitePreload(async () => {
      const { offchainLookup: offchainLookup3, offchainLookupSignature: offchainLookupSignature3 } = await Promise.resolve().then(() => ccip);
      return { offchainLookup: offchainLookup3, offchainLookupSignature: offchainLookupSignature3 };
    }, true ? void 0 : void 0, import.meta.url);
...
class OffchainLookupError extends BaseError$2 {
...
class OffchainLookupResponseMalformedError extends BaseError$2 {
...
class OffchainLookupSenderMismatchError extends BaseError$2 {
...
function toPrefixedMessage(message_) {
  ...
  const prefix = stringToHex(`${presignMessagePrefix}${size$2(message)}`);
  ...
  const validateData = (struct, data) => {
    for (const param of struct) {
      ...
      if (bytesMatch) {
        ...
        if (size_ && size$2(value) !== Number.parseInt(size_, 10))
...
class InvalidAddressError2 extends BaseError2 {
...
class NegativeOffsetError2 extends BaseError2 {
  constructor({ offset }) {
    super(`Offset \`${offset}\` cannot be negative.`);
    Object.defineProperty(this, "name", {
      enumerable: true,
...
class PositionOutOfBoundsError2 extends BaseError2 {
  constructor({ length, position }) {
...
class RecursiveReadLimitExceededError2 extends BaseError2 {
  constructor({ count, limit }) {
...
class BytesSizeMismatchError2 extends BaseError2 {
  constructor({ expectedSize, value }) {
...
class InvalidArrayError2 extends BaseError2 {
  constructor(value) {
...
class InvalidSerializedSizeError extends BaseError2 {
  constructor({ signature }) {
...
export {
  ...
  bn as AtomicReadyWalletRejectedUpgradeError,
  bm as AtomicityNotSupportedError,
  BaseError$2 as BaseError,
  BaseFeeScalarError,
  BlockNotFoundError,
  bo as BundleTooLargeError,
  BytesSizeMismatchError$1 as BytesSizeMismatchError,
  CallExecutionError,
  bp as ChainDisconnectedError,
  ...
  IntegerOutOfRangeError$1 as IntegerOutOfRangeError,
  InternalRpcError,
  ...
  InvalidAddressError$1 as InvalidAddressError,
  InvalidArrayError$1 as InvalidArrayError,
  InvalidBytesBooleanError$1 as InvalidBytesBooleanError,
  ...
  br as InvalidParamsRpcError,
  InvalidParenthesisError,
  InvalidPrimaryTypeError,
  bs as InvalidRequestRpcError,
  InvalidSerializableTransactionError,
  InvalidSignatureError,
  InvalidStructSignatureError,
  InvalidStructTypeError,
  bt as JsonRpcVersionUnsupportedError,
  bu as LimitExceededRpcError,
  MaxFeePerGasTooLowError,
  bv as MethodNotFoundRpcError,
  bw as MethodNotSupportedRpcError,
  NonceMaxValueError,
  NonceTooHighError,
  NonceTooLowError,
  bx as ParseRpcError,
  by as ProviderDisconnectedError,
  bz as ProviderRpcError,
  RawContractError,
  bA as ResourceNotFoundRpcError,
  bB as ResourceUnavailableRpcError,
  bC as RpcError,
  RpcRequestError,
  bi as SizeExceedsPaddingSizeError,
  bk as SizeOverflowError,
  SliceOffsetOutOfBoundsError$1 as SliceOffsetOutOfBoundsError,
  SolidityProtectedKeywordError,
  StateAssignmentConflictError,
  bD as SwitchChainError,
  bl as TimeoutError,
  TipAboveFeeCapError,
  TransactionNotFoundError,
  TransactionReceiptNotFoundError,
  bE as TransactionRejectedRpcError,
  TransactionTypeNotSupportedError,
  bF as UnauthorizedProviderError,
  bG as UnknownBundleIdError,
  UnknownNodeError,
  bH as UnknownRpcError,
  UnknownSignatureError,
  UnknownTypeError,
  bI as UnsupportedChainIdError,
  bJ as UnsupportedNonOptionalCapabilityError,
  bK as UnsupportedProviderMethodError,
  bM as UrlRequiredError,
  bL as UserRejectedRequestError,
  ...
  concat$1 as concat,
  concatBytes$1 as concatBytes,
  concatHex,
  createClient,
  createPublicClient,
  bc as createTransport,
  decodeAbiParameters,
  decodeErrorResult,
  decodeEventLog,
  decodeFunctionData,
  ...
  hexToBigInt,
  hexToBool,
  hexToBytes$1 as hexToBytes,
  hexToNumber$1 as hexToNumber,
  bf as http,
  isAddress,
  isAddressEqual,
  isHex,
  keccak256$1 as keccak256,
  labelhash,
  maxUint256$1 as maxUint256,
  multicall3Abi,
  namehash,
  numberToBytes,
  numberToHex,
