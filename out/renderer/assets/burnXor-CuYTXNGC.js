import { aF as getCurrentIndexer, aG as IndexerType, F as FPNumber, aH as gql } from "./index-73GArslZ.js";
const dataBeforeSubqueryIndexing = [
...
const getSubqueryXorBurnQuery = (address) => gql`
...
`;
const getSubsquidXorBurnQuery = (address) => gql`
...
async function fetchData(start, end, accountId) {
  ...
  switch (indexer.type) {
    case IndexerType.SUBQUERY: {
      ...
      const initData = accountId ? dataBeforeSubqueryIndexing.filter((item) => item.address === accountId) : dataBeforeSubqueryIndexing;
