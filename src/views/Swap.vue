...
export default class Swap extends Mixins(mixins.LoadingMixin, TranslationMixin, SelectedTokenRouteMixin) {
  ...
  readonly DefaultLayouts: ResponsiveLayouts = {
    ...
    md: [
      ...
      { x: 4, y: 20, w: 6, h: 4, minW: 4, minH: 4, i: SwapWidgets.Customise },
      { x: 4, y: 24, w: 6, h: 16, minW: 4, minH: 16, i: SwapWidgets.PriceChartA },
      { x: 10, y: 0, w: 6, h: 24, minW: 4, minH: 24, i: SwapWidgets.Transactions },
      { x: 10, y: 24, w: 6, h: 16, minW: 4, minH: 16, i: SwapWidgets.PriceChartB },
    ],
    sm: [
      { x: 0, y: 0, w: 4, h: 20, minW: 4, minH: 20, i: SwapWidgets.Form },
      { x: 0, y: 20, w: 4, h: 4, minW: 4, minH: 4, i: SwapWidgets.Distribution },
      { x: 4, y: 0, w: 4, h: 20, minW: 4, minH: 20, i: SwapWidgets.Chart },
      { x: 4, y: 20, w: 4, h: 4, minW: 4, minH: 4, i: SwapWidgets.Customise },
      { x: 4, y: 24, w: 4, h: 20, minW: 4, minH: 20, i: SwapWidgets.PriceChartA },
      { x: 8, y: 0, w: 4, h: 24, minW: 4, minH: 24, i: SwapWidgets.Transactions },
      { x: 8, y: 24, w: 4, h: 20, minW: 4, minH: 20, i: SwapWidgets.PriceChartB },
    ],
    xs: [
