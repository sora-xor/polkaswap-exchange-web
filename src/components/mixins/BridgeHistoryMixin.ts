...
export default class BridgeHistoryMixin extends Mixins(LoadingMixin) {
  ...
  @Action('setSoraTransactionHash', { namespace }) setSoraTransactionHash!: (soraTransactionHash: string) => Promise<void>
  @Action('setEvmTransactionHash', { namespace }) setEvmTransactionHash!: (evmTransactionHash: string) => Promise<void>
  @Action('setSoraTransactionDate', { namespace }) setSoraTransactionDate!: (soraTransactionDate: string) => Promise<void>
