...
import { r as c, c as v, n as p } from './index-D1vJKCDW.mjs';
import { o as m } from './if-defined-DgIoGpc1.mjs';
import './index-CnQvofHo.mjs';
import { O as B } from './index-BikJzTW8.mjs';
...
import { E as w } from './ExchangeController-BOCYJt5l.mjs';
...
var j = function (t, e, r, o) {
  var s = arguments.length,
    i = s < 3 ? e : o === null ? (o = Object.getOwnPropertyDescriptor(e, r)) : o,
    n;
  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function') i = Reflect.decorate(t, e, r, o);
  else for (var a = t.length - 1; a >= 0; a--) (n = t[a]) && (i = (s < 3 ? n(i) : s > 3 ? n(e, r, i) : n(e, r)) || i);
...
let I = class extends g {
  constructor() {
    (super(),
      ...
      (this.currencyImages = R.state.currencyImages),
      ...
      this.unsubscribe.push(
        ...
        R.subscribeKey('currencyImages', (e) => (this.currencyImages = e)),
  ...
  render() {
    const { termsConditionsUrl: e, privacyPolicyUrl: r } = x.state,
      o = x.state.features?.legalCheckbox,
      n = !!(e || r) && !!o && !this.checked;
    return u`
  ...
  selectCurrency(e) {
    e && (l.setPaymentCurrency(e), k.close());
  }
};
I.styles = X;
j([c()], I.prototype, 'selectedCurrency', void 0);
j([c()], I.prototype, 'currencies', void 0);
j([c()], I.prototype, 'currencyImages', void 0);
j([c()], I.prototype, 'checked', void 0);
I = j([v('w3m-onramp-fiat-select-view')], I);
const H = E`
  button {
...
let h = class extends g {
  ...
  networksTemplate() {
    const r = O.getAllRequestedCaipNetworks()
      ?.filter((o) => o?.assets?.imageId)
      ?.slice(0, 5);
    return u`
...
h.styles = [H];
C([p({ type: Boolean })], h.prototype, 'disabled', void 0);
C([p()], h.prototype, 'color', void 0);
C([p()], h.prototype, 'name', void 0);
C([p()], h.prototype, 'label', void 0);
C([p()], h.prototype, 'feeRange', void 0);
C([p({ type: Boolean })], h.prototype, 'loading', void 0);
C([p()], h.prototype, 'onClick', void 0);
h = C([v('w3m-onramp-provider-item')], h);
...
let L = class extends g {
  ...
  onRampProvidersTemplate() {
    return this.providers
      .filter((e) => e.supportedChains.includes(O.state.activeChain ?? 'eip155'))
      .map(
        (e) => u`
  ...
  onClickProvider(e) {
    (l.setSelectedProvider(e),
      P.push('BuyInProgress'),
      N.openHref(l.state.selectedProvider?.url || e.url, 'popupWindow', 'width=600,height=800,scrollbars=yes'),
      K.sendEvent({
        type: 'track',
        event: 'SELECT_BUY_PROVIDER',
        properties: {
          provider: e.name,
          isSmartAccount: z(O.state.activeChain) === M.ACCOUNT_TYPES.SMART_ACCOUNT,
        },
      }));
  }
};
F([c()], L.prototype, 'providers', void 0);
L = F([v('w3m-onramp-providers-view')], L);
const G = E`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
...
let A = class extends g {
  constructor() {
    (super(),
      ...
      (this.tokenImages = R.state.tokenImages),
      (this.checked = B.state.isLegalCheckboxChecked),
      this.unsubscribe.push(
        l.subscribe((e) => {
  ...
  selectToken(e) {
    e && (l.setPurchaseCurrency(e), k.close());
  }
};
A.styles = G;
S([c()], A.prototype, 'selectedCurrency', void 0);
S([c()], A.prototype, 'tokens', void 0);
S([c()], A.prototype, 'tokenImages', void 0);
S([c()], A.prototype, 'checked', void 0);
A = S([v('w3m-onramp-token-select-view')], A);
const J = E`
  @keyframes shake {
    0% {
...
let d = class extends g {
  ...
  onTryAgain() {
    this.selectedOnRampProvider &&
      ((this.error = !1),
      N.openHref(this.selectedOnRampProvider.url, 'popupWindow', 'width=600,height=800,scrollbars=yes'));
  }
  tryAgainTemplate() {
    return this.selectedOnRampProvider?.url
      ? u`<wui-button size="md" variant="accent" @click=${this.onTryAgain.bind(this)}>
  ...
  loaderTemplate() {
    ...
    return u`<wui-loading-thumbnail radius=${r * 9}></wui-loading-thumbnail>`;
  }
  onCopyUri() {
    if (!this.selectedOnRampProvider?.url) {
      (D.showError('No link found'), P.goBack());
      return;
    }
    try {
      (N.copyToClopboard(this.selectedOnRampProvider.url), D.showSuccess('Link copied'));
    } catch {
...
d.styles = J;
y([c()], d.prototype, 'intervalId', void 0);
y([c()], d.prototype, 'selectedOnRampProvider', void 0);
y([c()], d.prototype, 'uri', void 0);
y([c()], d.prototype, 'ready', void 0);
y([c()], d.prototype, 'showRetry', void 0);
y([c()], d.prototype, 'buffering', void 0);
y([c()], d.prototype, 'error', void 0);
y([p({ type: Boolean })], d.prototype, 'isMobile', void 0);
y([p()], d.prototype, 'onRetry', void 0);
d = y([v('w3m-buy-in-progress-view')], d);
...
U = Z([v('w3m-what-is-a-buy-view')], U);
...
let _ = class extends g {
  constructor() {
    (super(),
      (this.unsubscribe = []),
      (this.activeCaipNetwork = O.state.activeCaipNetwork),
      (this.features = x.state.features),
      (this.remoteFeatures = x.state.remoteFeatures),
      (this.exchangesLoading = w.state.isLoading),
      (this.exchanges = w.state.exchanges),
      this.unsubscribe.push(
        x.subscribeKey('features', (e) => (this.features = e)),
        x.subscribeKey('remoteFeatures', (e) => (this.remoteFeatures = e)),
        O.subscribeKey('activeCaipNetwork', (e) => {
          ((this.activeCaipNetwork = e), this.setDefaultPaymentAsset());
        }),
        w.subscribeKey('isLoading', (e) => (this.exchangesLoading = e)),
        w.subscribeKey('exchanges', (e) => (this.exchanges = e))
      ));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  ...
  async firstUpdated() {
    w.isPayWithExchangeSupported() && (await this.setDefaultPaymentAsset(), await w.fetchExchanges());
  }
  render() {
    return u`
  ...
  async setDefaultPaymentAsset() {
    ...
    const e = await w.getAssetsForNetwork(this.activeCaipNetwork.caipNetworkId),
      r = e.find((o) => o.metadata.symbol === 'USDC') || e[0];
    r && w.setPaymentAsset(r);
  }
  onrampTemplate() {
    if (!this.activeCaipNetwork) return null;
    const e = this.remoteFeatures?.onramp,
      r = Q.ONRAMP_SUPPORTED_CHAIN_NAMESPACES.includes(this.activeCaipNetwork.chainNamespace);
    return !e || !r
      ? null
      : u`
      <wui-list-item
  ...
  depositFromExchangeTemplate() {
    return !this.activeCaipNetwork || !w.isPayWithExchangeSupported()
      ? null
      : u`
      <wui-list-item
  ...
  onBuyCrypto() {
    P.push('OnRampProviders');
  }
  onReceive() {
    P.push('WalletReceive');
  }
  onDepositFromExchange() {
    P.push('PayWithExchange', {
      redirectView: P.state.data?.redirectView,
    });
  }
};
W([c()], _.prototype, 'activeCaipNetwork', void 0);
W([c()], _.prototype, 'features', void 0);
W([c()], _.prototype, 'remoteFeatures', void 0);
W([c()], _.prototype, 'exchangesLoading', void 0);
W([c()], _.prototype, 'exchanges', void 0);
_ = W([v('w3m-fund-wallet-view')], _);
const ee = E`
  :host {
    width: 100%;
  }
...
let b = class extends g {
  ...
  render() {
    const e = this.selectedCurrency?.symbol || '',
      r = this.currencyImages[e] || this.tokenImages[e];
    return u`<wui-input-text type="number" size="lg" value=${this.value}>
      ${
        this.selectedCurrency
          ...
          : u`<wui-loading-spinner></wui-loading-spinner>`
      }
    </wui-input-text>`;
  }
...
b.styles = ee;
T([p({ type: String })], b.prototype, 'type', void 0);
T([p({ type: Number })], b.prototype, 'value', void 0);
T([c()], b.prototype, 'currencies', void 0);
T([c()], b.prototype, 'selectedCurrency', void 0);
T([c()], b.prototype, 'currencyImages', void 0);
T([c()], b.prototype, 'tokenImages', void 0);
b = T([v('w3m-onramp-input')], b);
const te = E`
  :host > wui-flex {
    width: 100%;
    max-width: 360px;
...
let f = class extends g {
  constructor() {
    (super(),
      (this.unsubscribe = []),
      (this.disabled = !1),
      (this.caipAddress = O.state.activeCaipAddress),
      (this.loading = k.state.loading),
      ...
      this.unsubscribe.push(
        O.subscribeKey('activeCaipAddress', (e) => (this.caipAddress = e)),
        k.subscribeKey('loading', (e) => {
          this.loading = e;
        }),
        l.subscribe((e) => {
  ...
  getQuotes() {
    this.loading || k.open({ view: 'OnRampProviders' });
  }
  openModal() {
    k.open({ view: 'Connect' });
  }
...
f.styles = te;
$([p({ type: Boolean })], f.prototype, 'disabled', void 0);
$([c()], f.prototype, 'caipAddress', void 0);
$([c()], f.prototype, 'loading', void 0);
$([c()], f.prototype, 'paymentCurrency', void 0);
$([c()], f.prototype, 'paymentAmount', void 0);
$([c()], f.prototype, 'purchaseAmount', void 0);
$([c()], f.prototype, 'quoteLoading', void 0);
f = $([v('w3m-onramp-widget')], f);
export {
  d as W3mBuyInProgressView,
  _ as W3mFundWalletView,
  L as W3mOnRampProvidersView,
  I as W3mOnrampFiatSelectView,
  A as W3mOnrampTokensView,
  f as W3mOnrampWidget,
  U as W3mWhatIsABuyView,
};
//# sourceMappingURL=onramp-CelqYLVO.mjs.map
