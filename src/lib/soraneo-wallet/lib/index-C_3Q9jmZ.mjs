import { k as d, r as m, l as c, m as f, v, x as h } from './index-CgrbEUSl.mjs';
import { n as r, c as y, U as b } from './index-D1vJKCDW.mjs';
import { e as g, n as w } from './ref-CBFqMm98.mjs';
const x = d`
  :host {
    position: relative;
...
var a = function (t, e, n, s) {
  var p = arguments.length,
    o = p < 3 ? e : s === null ? (s = Object.getOwnPropertyDescriptor(e, n)) : s,
    l;
...
let i = class extends f {
  ...
  dispatchInputChangeEvent() {
    this.inputElementRef.value &&
      ((this.inputElementRef.value.value = b.maskInput({
...
a([r({ type: String })], i.prototype, 'value', void 0);
a([r({ type: String })], i.prototype, 'placeholder', void 0);
a([r({ type: String })], i.prototype, 'widthVariant', void 0);
a([r({ type: Number })], i.prototype, 'maxDecimals', void 0);
a([r({ type: Number })], i.prototype, 'maxIntegers', void 0);
a([r({ type: String })], i.prototype, 'fontSize', void 0);
a([r({ type: Boolean })], i.prototype, 'error', void 0);
i = a([y('wui-input-amount')], i);
//# sourceMappingURL=index-C_3Q9jmZ.mjs.map
