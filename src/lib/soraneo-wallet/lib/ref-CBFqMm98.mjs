import { j as l } from './index-CgrbEUSl.mjs';
import { i as $, t as a, e as f } from './index-D1vJKCDW.mjs';
/**
 * @license
...
function u(t, s = !1, e = 0) {
  const i = this._$AH,
    c = this._$AN;
  if (c !== void 0 && c.size !== 0)
    if (s)
      if (Array.isArray(i)) for (let o = e; o < i.length; o++) (h(i[o], !1), n(i[o]));
...
class p extends $ {
  ...
  _$AO(s, e = !0) {
    (s !== this.isConnected && ((this.isConnected = s), s ? this.reconnected?.() : this.disconnected?.()),
      e && (h(this, s), n(this)));
  }
  setValue(s) {
    ...
    class extends p {
      ...
      update(t, [s]) {
        ...
        return (
          ...
          (e || this.lt !== this.ct) && ((this.G = s), (this.ht = t.options?.host), this.rt((this.ct = t.element))),
          l
        );
      }
      rt(t) {
        if ((this.isConnected || (t = void 0), typeof this.G == 'function')) {
          ...
          let e = r.get(s);
          (e === void 0 && ((e = /* @__PURE__ */ new WeakMap()), r.set(s, e)),
...
export { N as e, m as n };
//# sourceMappingURL=ref-CBFqMm98.mjs.map
