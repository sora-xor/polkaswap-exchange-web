import { n as g, Y as d, t as r, p as c, O as i, s as u } from './property-CZ5dXgER.mjs';
...
t.weightsMap = /* @__PURE__ */ new Map([
  ...
  ['bold', r`<path d="M168.49,199.51a12,12,0,0,1-17,17l-80-80a12,12,0,0,1,0-17l80-80a12,12,0,0,1,17,17L97,128Z"/>`],
  ['fill', r`<path d="M168,48V208a8,8,0,0,1-13.66,5.66l-80-80a8,8,0,0,1,0-11.32l80-80A8,8,0,0,1,168,48Z"/>`],
  [
    'duotone',
...
t.styles = c`
  ...
  `;
l([i({ type: String, reflect: !0 })], t.prototype, 'size', 2);
l([i({ type: String, reflect: !0 })], t.prototype, 'weight', 2);
l([i({ type: String, reflect: !0 })], t.prototype, 'color', 2);
l([i({ type: Boolean, reflect: !0 })], t.prototype, 'mirrored', 2);
t = l([u('ph-caret-left')], t);
export { t as PhCaretLeft };
//# sourceMappingURL=PhCaretLeft-DxHc6565.mjs.map
