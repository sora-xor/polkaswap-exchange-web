import { k as u, r as h, l as f, m as p, x as g } from './index-CgrbEUSl.mjs';
import { n as d, c as m } from './index-D1vJKCDW.mjs';
import { o as b } from './if-defined-DgIoGpc1.mjs';
const y = u`
  :host {
    display: inline-flex;
...
var a = function (o, e, c, n) {
  var i = arguments.length,
    r = i < 3 ? e : n === null ? (n = Object.getOwnPropertyDescriptor(e, c)) : n,
    s;
...
t.styles = [h, f, y];
a([d()], t.prototype, 'icon', void 0);
a([d()], t.prototype, 'size', void 0);
a([d()], t.prototype, 'padding', void 0);
a([d()], t.prototype, 'color', void 0);
t = a([m('wui-icon-box')], t);
//# sourceMappingURL=index-v0YluuaR.mjs.map
