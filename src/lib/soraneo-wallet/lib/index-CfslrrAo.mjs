...
import { n as h, c as v, r as d, U as T } from './index-D1vJKCDW.mjs';
...
`;
var y = function (i, t, e, n) {
  var r = arguments.length,
    o = r < 3 ? t : n === null ? (n = Object.getOwnPropertyDescriptor(t, e)) : n,
    s;
  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function') o = Reflect.decorate(i, t, e, n);
  else for (var a = i.length - 1; a >= 0; a--) (s = i[a]) && (o = (r < 3 ? s(o) : r > 3 ? s(t, e, o) : s(t, e)) || o);
...
c.styles = [E, P, L];
y([h({ type: Boolean })], c.prototype, 'disabled', void 0);
y([h({ type: String })], c.prototype, 'value', void 0);
c = y([v('wui-input-numeric')], c);
const _ = O`
  :host {
    position: relative;
    display: block;
...
let p = class extends b {
  constructor() {
    (super(...arguments),
      ...
      (this.numerics = []),
      (this.shouldInputBeEnabled = (t) => this.values.slice(0, t).every((n) => n !== '')),
      (this.handleKeyDown = (t, e) => {
        const n = t.target,
          r = this.getInputElement(n),
          o = ['ArrowLeft', 'ArrowRight', 'Shift', 'Delete'];
        if (!r) return;
      ...
      (this.focusInputField = (t, e) => {
        if (t === 'next') {
          ...
          const r = this.numerics[n < this.length ? n : e],
            o = r ? this.getInputElement(r) : void 0;
          o && ((o.disabled = !1), o.focus());
        }
        if (t === 'prev') {
          const n = e - 1,
            r = this.numerics[n > -1 ? n : e],
            o = r ? this.getInputElement(r) : void 0;
          o && o.focus();
        }
      }));
  ...
  firstUpdated() {
    ...
    const t = this.shadowRoot?.querySelectorAll('wui-input-numeric');
    (t && (this.numerics = Array.from(t)), this.numerics[0]?.focus());
  }
  render() {
    return l`
  ...
  updateInput(t, e, n) {
    const r = this.numerics[e],
      o = t || (r ? this.getInputElement(r) : void 0);
    o && ((o.value = n), (this.values = this.values.map((s, a) => (a === e ? n : s))));
  }
  selectInput(t) {
    const e = t.target;
    e && this.getInputElement(e)?.select();
  }
  handleInput(t, e) {
    const n = t.target,
      r = this.getInputElement(n);
    if (r) {
      ...
      t.inputType === 'insertFromPaste'
        ? this.handlePaste(r, o, e)
        : T.isNumber(o) && t.data
          ? (this.updateInput(r, e, t.data), this.focusInputField('next', e))
          : this.updateInput(r, e, '');
    }
  ...
  handlePaste(t, e, n) {
    const r = e[0];
    if (r && T.isNumber(r)) {
      this.updateInput(t, n, r);
      const s = e.substring(1);
      if (n + 1 < this.length && s.length) {
        const a = this.numerics[n + 1],
          x = a ? this.getInputElement(a) : void 0;
        x && this.handlePaste(x, s, n + 1);
      } else this.focusInputField('next', n);
    } else this.updateInput(t, n, '');
  }
  getInputElement(t) {
    return t.shadowRoot?.querySelector('input') ? t.shadowRoot.querySelector('input') : null;
  }
...
p.styles = [E, _];
m([h({ type: Number })], p.prototype, 'length', void 0);
m([h({ type: String })], p.prototype, 'otp', void 0);
m([d()], p.prototype, 'values', void 0);
p = m([v('wui-otp')], p);
const k = O`
  wui-loading-spinner {
    margin: 9px auto;
...
let u = (w = class extends b {
  ...
  constructor() {
    (super(),
      (this.loading = !1),
      (this.timeoutTimeLeft = g.getTimeToNextEmailLogin()),
      (this.error = ''),
      (this.otp = ''),
      (this.email = S.state.data?.email),
      (this.authConnector = I.getAuthConnector()));
  }
  render() {
    if (!this.email) throw new Error('w3m-email-otp-widget: No email provided');
    const t = !!this.timeoutTimeLeft,
      e = this.getFooterLabels(t);
    return l`
      <wui-flex
      ...
      >
        ...
        ${
          this.loading
            ? l`<wui-loading-spinner size="xl" color="accent-primary"></wui-loading-spinner>`
            : l` <wui-flex flexDirection="column" alignItems="center" gap="2">
              <wui-otp
                dissabled
                length="6"
  ...
  async onOtpInputChange(t) {
    try {
      this.loading ||
        ((this.otp = t.detail),
        this.shouldSubmitOnOtpChange() && ((this.loading = !0), await this.onOtpSubmit?.(this.otp)));
    } catch (e) {
      ((this.error = R.parseError(e)), (this.loading = !1));
    }
  }
  async onResendCode() {
    try {
...
u.OTP_LENGTH = 6;
u.styles = k;
f([d()], u.prototype, 'loading', void 0);
f([d()], u.prototype, 'timeoutTimeLeft', void 0);
f([d()], u.prototype, 'error', void 0);
u = w = f([v('w3m-email-otp-widget')], u);
export { u as W };
//# sourceMappingURL=index-CfslrrAo.mjs.map
