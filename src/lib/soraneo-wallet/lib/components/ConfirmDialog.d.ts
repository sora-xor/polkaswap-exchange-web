...
declare const ConfirmDialog_base: import('vue-class-component').VueConstructor<
  LoadingMixin &
    NotificationMixin & {
...
export default class ConfirmDialog extends ConfirmDialog_base {
  readonly account: PolkadotJsAccount;
  ...
  private resetAccountPassphrase;
  get visible(): boolean;
  set visible(flag: boolean);
  get passphrase(): Nullable<string>;
  handleConfirm(password: string): Promise<void>;
}
export {};
