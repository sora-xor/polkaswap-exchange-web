...
declare const AddAssetNFT_base: import('vue-class-component').VueConstructor<
  AddAssetMixin & {
...
>;
export default class AddAssetNFT extends AddAssetNFT_base {
  private get notAddedNftAssets();
