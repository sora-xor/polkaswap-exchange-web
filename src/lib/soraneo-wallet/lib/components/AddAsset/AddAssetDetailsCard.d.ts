...
import { default as AddAssetMixin } from '../mixins/AddAssetMixin';
import { default as LoadingMixin } from '../mixins/LoadingMixin';
import { default as TranslationMixin } from '../mixins/TranslationMixin';
import { WhitelistIdsBySymbol } from '../../types/common';
import { Asset, Whitelist } from '@sora-substrate/sdk/build/assets/types';

declare const AddAssetDetailsCard_base: import('vue-class-component').VueConstructor<
  TranslationMixin &
    LoadingMixin &
    AddAssetMixin & {
...
>;
export default class AddAssetDetailsCard extends AddAssetDetailsCard_base {
  whitelist: Whitelist;
  whitelistIdsBySymbol: WhitelistIdsBySymbol;
  readonly selectAssets: Array<Asset>;
