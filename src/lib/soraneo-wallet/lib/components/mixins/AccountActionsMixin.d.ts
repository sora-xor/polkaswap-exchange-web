import { default as LoadingMixin } from './LoadingMixin';
import { default as NotificationMixin } from './NotificationMixin';
import { PolkadotJsAccount } from '../../types/common';

declare const AccountActionsMixin_base: import('vue-class-component').VueConstructor<
  LoadingMixin &
    NotificationMixin & {
...
>;
export default class AccountActionsMixin extends AccountActionsMixin_base {
  ...
  handleAccountRename(name: string): Promise<void>;
  handleAccountExport(password: string): Promise<void>;
  handleAccountDelete(allowAccountDeletePopup?: boolean): Promise<void>;
}
export {};
