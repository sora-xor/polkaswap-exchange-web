...
declare const NetworkFeeWarningMixin_base: import('vue-class-component').VueConstructor<
...
>;
export default class NetworkFeeWarningMixin extends NetworkFeeWarningMixin_base {
