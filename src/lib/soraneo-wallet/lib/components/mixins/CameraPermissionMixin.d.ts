...
declare const CameraPermissionMixin_base: import('vue-class-component').VueConstructor<
  NotificationMixin & {
...
>;
export default class CameraPermissionMixin extends CameraPermissionMixin_base {
  permissionDialogVisibility: boolean;
  checkMediaDevicesAllowance(context: string): Promise<boolean>;
}
export {};
