import { AsyncFnWithoutArgs } from '../../composables/useNotification';
import { NotificationSeverity } from '../../services/notification';
import { default as TranslationMixin } from './TranslationMixin';

declare const NotificationMixin_base: import('vue-class-component').VueConstructor<
  TranslationMixin & {
...
>;
export default class NotificationMixin extends NotificationMixin_base {
