import { default as InputFocusMixin } from '../mixins/InputFocusMixin';
import { default as TranslationMixin } from '../mixins/TranslationMixin';

declare const PasswordInput_base: import('vue-class-component').VueConstructor<
  InputFocusMixin &
    TranslationMixin & {
...
>;
export default class PasswordInput extends PasswordInput_base {
  query: string;
  hidden: boolean;
  get icon(): string;
  get type(): string;
