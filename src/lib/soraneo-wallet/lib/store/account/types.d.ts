...
import { FiatPriceObject } from '../../services/indexer/subsquid/types';
import { Wallet } from '../../services/wallet/types';
import { Book, AddressKeyMapping, KeyringPair$Json } from '../../types/common';
import {
  AccountAsset,
  Asset,
  Blacklist,
...
export type VestedTransferParams = VestedTransferFeeParams & {
  to: string;
  start: number;
  current: number;
};
