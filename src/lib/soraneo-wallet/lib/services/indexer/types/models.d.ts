...
import { StakingRewardsDestination } from '@sora-substrate/sdk/build/staking/types';

export declare enum SnapshotTypes {
  DEFAULT = 'DEFAULT',
  HOUR = 'HOUR',
  DAY = 'DAY',
  MONTH = 'MONTH',
...
export declare enum HistoryElementType {
  CALL = 'CALL',
  EVENT = 'EVENT',
}
export declare enum PayeeType {
  STAKED = 'STAKED',
  STASH = 'STASH',
