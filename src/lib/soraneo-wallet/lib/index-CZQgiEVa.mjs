import { a9 as he, Q as x, k as de, r as ge, m as me, x as j } from './index-CgrbEUSl.mjs';
import { n as z, c as we } from './index-D1vJKCDW.mjs';
...
function Ce() {
  ...
  return (
    (r.prototype = {
      ...
      put: function (o, i) {
        for (let n = 0; n < i; n++) this.putBit(((o >>> (i - n - 1)) & 1) === 1);
      },
      ...
      putBit: function (o) {
        ...
        (this.buffer.length <= i && this.buffer.push(0),
          o && (this.buffer[i] |= 128 >>> this.length % 8),
          this.length++);
      },
    }),
    (rt = r),
...
function Ee() {
  ...
  return (
    (r.prototype.set = function (o, i, n, t) {
    ...
    kt ||
      ...
      (function (r) {
        ...
        ((r.isValid = function (t) {
          ...
          (r.getPenaltyN1 = function (t) {
            ...
            for (let A = 0; A < e; A++) {
              ...
              for (let E = 0; E < e; E++) {
                let h = t.get(A, E);
                (h === c ? a++ : (a >= 5 && (s += o.N1 + (a - 5)), (c = h), (a = 1)),
                  (h = t.get(E, A)),
                  h === m ? u++ : (u >= 5 && (s += o.N1 + (u - 5)), (m = h), (u = 1)));
              }
        ...
        ((r.applyMask = function (t, e) {
          const s = e.size;
          for (let a = 0; a < s; a++) for (let u = 0; u < s; u++) e.isReserved(u, a) || e.xor(u, a, i(t, u, a));
        }),
...
function Ae() {
  ...
  return (
    (function () {
      let n = 1;
      for (let t = 0; t < 255; t++) ((r[t] = n), (o[n] = t), (n <<= 1), n & 256 && (n ^= 285));
    ...
    zt ||
      ...
      (function (r) {
        ...
        ((r.mul = function (n, t) {
          ...
          for (let s = 0; s < n.length; s++) for (let a = 0; a < t.length; a++) e[s + a] ^= o.mul(n[s], t[a]);
          return e;
        }),
          (r.mod = function (n, t) {
            ...
            for (; e.length - t.length >= 0; ) {
              const s = e[0];
              for (let u = 0; u < t.length; u++) e[u] ^= o.mul(t[u], s);
              let a = 0;
          ...
          (r.generateECPolynomial = function (n) {
            ...
            for (let e = 0; e < n; e++) t = r.mul(t, new Uint8Array([1, o.exp(e)]));
            return t;
          }));
      })(at)),
    at
...
function ue() {
  ...
  ((v.KANJI = new RegExp(i, 'g')),
    (v.BYTE_KANJI = new RegExp('[^A-Z0-9 $%*+\\-./:]+', 'g')),
    (v.BYTE = new RegExp(n, 'g')),
    (v.NUMERIC = new RegExp(r, 'g')),
    (v.ALPHANUMERIC = new RegExp(o, 'g')));
  const t = new RegExp('^' + i + '$'),
    e = new RegExp('^' + r + '$'),
    s = new RegExp('^[A-Z0-9 $%*+\\-./:]+$');
  return (
    (v.testKanji = function (u) {
      return t.test(u);
    }),
    ...
    Ht ||
      ...
      (function (r) {
        const o = $(),
          ...
          a = o.getBCHDigit(s);
        function u(E, h, S) {
          for (let w = 1; w <= 40; w++) if (h <= r.getCapacity(w, S, E)) return w;
        }
        function c(E, h) {
          return t.getCharCountIndicator(E, h) + 4;
        }
        function m(E, h) {
          let S = 0;
          return (
        ...
        function A(E, h) {
          for (let S = 1; S <= 40; S++) if (m(E, S) <= r.getCapacity(S, h, t.MIXED)) return S;
        }
        ((r.from = function (h, S) {
          return e.isValid(h) ? parseInt(h, 10) : S;
        }),
          (r.getCapacity = function (h, S, w) {
            if (!e.isValid(h)) throw new Error('Invalid QR Code version');
            typeof w > 'u' && (w = t.BYTE);
            const b = o.getSymbolTotalCodewords(h),
          ...
          (r.getBestVersionForData = function (h, S) {
            let w;
            const b = n.from(S, n.M);
            if (Array.isArray(h)) {
              if (h.length > 1) return A(h, b);
          ...
          (r.getEncodedBits = function (h) {
            ...
            let S = h << 12;
            for (; o.getBCHDigit(S) - a >= 0; ) S ^= s << (o.getBCHDigit(S) - a);
            return (h << 12) | S;
          }));
      })(lt)),
    lt
...
function Se() {
  ...
  const r = $(),
    ...
    n = r.getBCHDigit(o);
  return (
    (dt.getEncodedBits = function (e, s) {
      const a = (e.bit << 3) | s;
      let u = a << 10;
      for (; r.getBCHDigit(u) - n >= 0; ) u ^= o << (r.getBCHDigit(u) - n);
      return ((a << 10) | u) ^ i;
    }),
    dt
  );
      ...
      (function (r) {
        var o = {
          single_source_shortest_paths: function (i, n, t) {
            ...
            a.push(n, 0);
            for (var u, c, m, A, E, h, S, w, b; !a.empty(); ) {
          ...
          find_path: function (i, n, t) {
            ...
            return o.extract_shortest_path_from_predecessor_list(e, t);
          },
          /**
  ...
  return (
    Xt ||
      ...
      (function (r) {
        ...
        function A(d) {
          const f = m(s.NUMERIC, o.NUMERIC, d),
            g = m(s.ALPHANUMERIC, o.ALPHANUMERIC, d);
          let l, P;
          return (
            a.isKanjiModeEnabled()
              ? ((l = m(s.BYTE, o.BYTE, d)), (P = m(s.KANJI, o.KANJI, d)))
              : ((l = m(s.BYTE_KANJI, o.BYTE, d)), (P = [])),
            f
              .concat(g, l, P)
              .sort(function (I, R) {
          ...
          for (let g = 0; g < d.length; g++) {
            ...
            switch (l.mode) {
              case o.NUMERIC:
                ...
                break;
              case o.ALPHANUMERIC:
                f.push([l, { data: l.data, mode: o.BYTE, length: l.length }]);
                break;
              case o.KANJI:
                f.push([l, { data: l.data, mode: o.BYTE, length: c(l.data) }]);
                break;
              case o.BYTE:
                f.push([{ data: l.data, mode: o.BYTE, length: c(l.data) }]);
            }
          }
          return f;
        }
            ...
            for (let y = 0; y < I.length; y++) {
              ...
              for (let N = 0; N < P.length; N++) {
                ...
                g[B] && g[B].node.mode === M.mode
                  ? ((l[B][p] = E(g[B].lastCount + M.length, M.mode) - E(g[B].lastCount, M.mode)),
                    (g[B].lastCount += M.length))
                  : (g[B] && (g[B].lastCount = M.length),
                    (l[B][p] = E(M.length, M.mode) + 4 + o.getCharCountIndicator(M.mode, f)));
              }
            }
            P = R;
          }
          for (let C = 0; C < P.length; C++) l[P[C]].end = 0;
          return { map: l, table: g };
        }
        function b(d, f) {
          let g;
          const l = o.getBestModeForData(d);
        ...
        ((r.fromArray = function (f) {
          ...
          (r.fromString = function (f, g) {
            const l = A(f, a.isKanjiModeEnabled()),
              P = S(l),
              C = w(P, g),
              I = u.find_path(C.map, 'start', 'end'),
              R = [];
            for (let y = 1; y < I.length - 1; y++) R.push(C.table[I[y]].node);
            return r.fromArray(h(R));
          }),
          (r.rawSplit = function (f) {
            return r.fromArray(A(f, a.isKanjiModeEnabled()));
          }));
      })(gt)),
    gt
  );
...
function _e() {
  ...
  function d(C, I, R) {
    const y = C.size,
      M = m.getEncodedBits(I, R);
    let p, N;
    for (p = 0; p < 15; p++)
      ((N = ((M >> p) & 1) === 1),
        p < 6 ? C.set(p, 8, N, !0) : p < 8 ? C.set(p + 1, 8, N, !0) : C.set(y - 15 + p, 8, N, !0),
        p < 8 ? C.set(8, y - p - 1, N, !0) : p < 9 ? C.set(8, 15 - p - 1 + 1, N, !0) : C.set(8, 15 - p - 1, N, !0));
    C.set(y - 8, 8, 1, !0);
  }
  function f(C, I) {
    const R = C.size;
      ...
      for (B === 6 && B--; ; ) {
        for (let T = 0; T < 2; T++)
          if (!C.isReserved(M, B - T)) {
            let k = !1;
            (N < I.length && (k = ((I[N] >>> p) & 1) === 1), C.set(M, B - T, k), p--, p === -1 && (N++, (p = 7)));
          }
        if (((M += y), M < 0 || R <= M)) {
          ((M -= y), (y = -y));
          break;
  ...
  function g(C, I, R) {
    ...
    const M = r.getSymbolTotalCodewords(C),
      p = a.getTotalCodewordsCount(C, I),
      N = (M - p) * 8;
    for (y.getLengthInBits() + 4 <= N && y.put(0, 4); y.getLengthInBits() % 8 !== 0; ) y.putBit(0);
    const B = (N - y.getLengthInBits()) / 8;
    for (let T = 0; T < B; T++) y.put(T % 2 ? 17 : 236, 8);
    return l(y, C, I);
  }
  function l(C, I, R) {
    const y = r.getSymbolTotalCodewords(I),
      M = a.getTotalCodewordsCount(I, R),
      p = y - M,
      N = a.getBlocksCount(I, R),
      B = y % N,
      T = N - B,
      k = Math.floor(y / N),
      H = Math.floor(p / N),
    ...
    let Mt = 0,
      D,
      q;
    for (D = 0; D < W; D++) for (q = 0; q < N; q++) D < Y[q].length && (X[Mt++] = Y[q][D]);
    for (D = 0; D < Nt; D++) for (q = 0; q < N; q++) X[Mt++] = St[q][D];
    return X;
  }
  function P(C, I, R, y) {
    let M;
    if (Array.isArray(C)) M = E.fromArray(C);
    else if (typeof C == 'string') {
      let k = I;
      if (!k) {
        const H = E.rawSplit(C);
        k = c.getBestVersionForData(H, R);
      }
      M = E.fromString(C, k || 40);
...
`
    ...
    return (
      ...
      I >= 7 && b(T, I),
      f(T, N),
      isNaN(y) && (y = s.getBestMask(T, d.bind(null, T, R))),
      s.applyMask(y, T),
      d(T, R, y),
      {
        modules: T,
          ...
          (r.qrToImageData = function (n, t, e) {
            ...
            for (let E = 0; E < c; E++)
              for (let h = 0; h < c; h++) {
                let S = (E * c + h) * 4,
                  w = e.color.light;
                if (E >= m && h >= m && E < c - m && h < c - m) {
                  const b = Math.floor((E - m) / u),
                    d = Math.floor((h - m) / u);
                  w = A[a[b * s + d] ? 1 : 0];
                }
    ...
    ee ||
      ...
      (function (r) {
        ...
        ((r.render = function (e, s, a) {
          ...
          const m = o.getImageWidth(e.modules.size, u),
            A = c.getContext('2d'),
            E = A.createImageData(m, m);
...
function Ue() {
  ...
  function n(t, e, s) {
    ...
    for (let A = 0; A < t.length; A++) {
      const E = Math.floor(A % e),
        h = Math.floor(A / e);
      (!E && !c && (c = !0),
        t[A]
          ? (m++,
            (A > 0 && E > 0 && t[A - 1]) || ((a += c ? i('M', E + s, 0.5 + h + s) : i('m', u, 0)), (u = 0), (c = !1)),
            (E + 1 < e && t[A + 1]) || ((a += i('h', m)), (m = 0)))
          : u++);
    }
    return a;
  }
  return (
    (At.render = function (e, s, a) {
      const u = r.getOptions(s),
        c = e.modules.size,
        m = e.modules.data,
        A = c + u.margin * 2,
        E = u.color.light.a ? '<path ' + o(u.color.light, 'fill') + ' d="M0 0h' + A + 'v' + A + 'H0z"/>' : '',
        h = '<path ' + o(u.color.dark, 'stroke') + ' d="' + n(m, c, u.margin) + '"/>',
        S = 'viewBox="0 0 ' + A + ' ' + A + '"',
        b =
...
function Fe() {
  ...
  function t(e, s, a, u, c) {
    const m = [].slice.call(arguments, 1),
      A = m.length,
      E = typeof m[A - 1] == 'function';
    if (!E && !r()) throw new Error('Callback required as last argument');
    if (E) {
      if (A < 2) throw new Error('Too few arguments provided');
      A === 2
        ? ((c = a), (a = s), (s = u = void 0))
        : A === 3 &&
          (s.getContext && typeof c > 'u' ? ((c = u), (u = void 0)) : ((c = u), (u = a), (a = s), (s = void 0)));
    } else {
      if (A < 1) throw new Error('Too few arguments provided');
      return (
        A === 1 ? ((a = s), (s = u = void 0)) : A === 2 && !s.getContext && ((u = a), (a = s), (s = void 0)),
  ...
  return (
    (O.create = o.create),
    (O.toCanvas = t.bind(null, i.render)),
    (O.toDataURL = t.bind(null, i.renderToDataURL)),
    (O.toString = t.bind(null, function (e, s, a) {
      return n.render(e, a);
    })),
    O
  );
...
function Ke(r, o) {
  const i = Array.prototype.slice.call($e.create(r, { errorCorrectionLevel: o }).modules.data, 0),
    ...
    generate({ uri: r, size: o, logoSize: i, padding: n = 8, dotColor: t = 'var(--apkt-colors-black)' }) {
      ...
      a.forEach((w, b) => {
        w.forEach((d, f) => {
          if (
            a[b][f] &&
            !((b < _ && f < _) || (b > a.length - (_ + 1) && f < _) || (b < _ && f > a.length - (_ + 1))) &&
            !(b > A && b < E && f > A && f < E)
          ) {
            const g = b * u + u / 2 + n,
              l = f * u + u / 2 + n;
      ...
      return (
        h.forEach(([w, b]) => {
          S[w] ? S[w]?.push(b) : (S[w] = [b]);
        }),
        Object.entries(S)
          .map(([w, b]) => {
            const d = b.filter((f) => b.every((g) => !bt(f, g, u)));
            return [Number(w), d];
          })
          .forEach(([w, b]) => {
            b.forEach((d) => {
              s.push(x`<circle cx=${w} cy=${d} fill=${t} r=${u / oe} />`);
            });
          }),
        Object.entries(S)
          .filter(([w, b]) => b.length > 1)
          .map(([w, b]) => {
            const d = b.filter((f) => b.some((g) => bt(f, g, u)));
            return [Number(w), d];
          })
          .map(([w, b]) => {
            b.sort((f, g) => (f < g ? -1 : 1));
            const d = [];
            for (const f of b) {
              const g = d.find((l) => l.some((P) => bt(f, P, u)));
              g ? g.push(f) : d.push([f]);
            }
...
var F = function (r, o, i, n) {
  var t = arguments.length,
    e = t < 3 ? o : n === null ? (n = Object.getOwnPropertyDescriptor(o, i)) : n,
    s;
...
L.styles = [ge, He];
F([z()], L.prototype, 'uri', void 0);
F([z({ type: Number })], L.prototype, 'size', void 0);
F([z()], L.prototype, 'theme', void 0);
F([z()], L.prototype, 'imageSrc', void 0);
F([z()], L.prototype, 'alt', void 0);
F([z({ type: Boolean })], L.prototype, 'arenaClear', void 0);
F([z({ type: Boolean })], L.prototype, 'farcaster', void 0);
L = F([we('wui-qr-code')], L);
//# sourceMappingURL=index-CZQgiEVa.mjs.map
