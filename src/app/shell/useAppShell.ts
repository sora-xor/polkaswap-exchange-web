...
export function useAppShell() {
  ...
  watch(
    ...
    (nextPath, prevPath) => {
      ...
      syncRouteScopedDialog(Boolean(web3Store.selectProviderDialogVisibility), web3Store.setSelectProviderDialogVisibility);
      syncRouteScopedDialog(Boolean(web3Store.selectNetworkDialogVisibility), web3Store.setSelectNetworkDialogVisibility);
      syncRouteScopedDialog(Boolean(web3Store.selectSubNodeDialogVisibility), web3Store.setSelectSubNodeDialogVisibility);
      syncRouteScopedDialog(Boolean(web3Store.subAccountDialogVisibility), web3Store.setSubAccountDialogVisibility);
      syncRouteScopedDialog(Boolean(settingsStore.selectNodeDialogVisibility), settingsStore.setSelectNodeDialogVisibility);
  ...
  watch(responsiveClass, (nextClass, prevClass) => {
    ...
    closeVisibleDialog(Boolean(settingsStore.selectIndexerDialogVisibility), settingsStore.setSelectIndexerDialogVisibility);
  });
  ...
  onBeforeMount(async () => {
    ...
    await withLoading(async () => {
      ...
      await bootstrapRuntimeServices({
        ...
        initializeIndexer: hasIndexerEndpoint && typeof settingsStore.selectIndexer === 'function'
