...
declare const store: {
    ...
    original: {
      ...
      install: (app: import('vue').App, injectKey?: import('vue').InjectionKey<Store<any>> | string) => void;
      replaceState: (state: {
        readonly wallet: {
          readonly account: import('direct-vuex/types/direct-types').DirectState<{
            namespaced: true;
      ...
      subscribe: <P extends import('vuex').MutationPayload>(
        fn: (
          mutation: P,
          state: {
            readonly wallet: {
                ...
                actions: {
                  ...
                  getVestedTransferFee(
                    context: import('vuex').ActionContext<any, any>,
                    {
                      ...
                      vestingPercent,
                      unlockPeriodInDays,
                    }: import('./account/types').VestedTransferFeeParams
                  ): Promise<Nullable<import('@sora-substrate/math').FPNumber>>;
                  vestedTransfer(
                    context: import('vuex').ActionContext<any, any>,
                    {
                ...
                actions: {
                  ...
                  getExternalHistory(
                    context: import('vuex').ActionContext<any, any>,
                    {
                      ...
                      page,
                      query,
                    }?: import('../types/history').ExternalHistoryParams
                  ): Promise<void>;
                  trackActiveTxs(context: import('vuex').ActionContext<any, any>): Promise<void>;
                  trackPendingMstTxs(context: import('vuex').ActionContext<any, any>): Promise<void>;
                  resetPendingMstTxsSubscription(context: import('vuex').ActionContext<any, any>): void;
        ...
        options?: import('vuex').SubscribeOptions
      ) => () => void;
      subscribeAction: <P extends import('vuex').ActionPayload>(
        fn: import('vuex').SubscribeActionOptions<
          P,
          {
            readonly wallet: {
              readonly account: import('direct-vuex/types/direct-types').DirectState<{
      ...
      registerModule: {
        <T>(
              ...
              readonly wallet: {
                ...
                readonly settings: import('direct-vuex/types/direct-types').DirectState<{
                  ...
                  mutations: {
                    ...
                    setExchangeRateUnsubFn(
                      state: import('./settings/types').SettingsState,
                      unsubFn: VoidFunction
                    ): void;
                    resetExchangeRateSubscription(state: import('./settings/types').SettingsState): void;
                    setAssetsFilter(
                      state: import('./settings/types').SettingsState,
          ...
          >,
          options?: import('vuex').ModuleOptions
        ): void;
        <T>(
          path: string[],
          module: import('vuex').Module<
                ...
                readonly wallet: {
                  ...
                  readonly router: import('direct-vuex/types/direct-types').DirectState<{
                    ...
                    mutations: {
                      navigate(
                        state: import('./router/types').RouterState,
                        params: import('./router/types').Route
                      ): void;
                    };
                    actions: {
                      back(context: import('vuex').ActionContext<any, any>): Promise<void>;
  ...
  rootActionContext: (originalContext: import('vuex').ActionContext<any, any>) => {
    rootState: {
