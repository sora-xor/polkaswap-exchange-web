import { TokenTabs, Step } from '../consts';
import TranslationMixin from './mixins/TranslationMixin';
declare const CreateToken_base: import('vue-class-component').VueConstructor<
  TranslationMixin & {
...
>;
export default class CreateToken extends CreateToken_base {
  readonly TokenTabs: typeof TokenTabs;
  private navigate;
  step: Step;
  currentTab: Step;
  showTabs: boolean;
