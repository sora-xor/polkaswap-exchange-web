...
declare const WalletAdarTxDetails_base: import('vue-class-component').VueConstructor<
  TranslationMixin &
...
>;
export default class WalletAdarTxDetails extends WalletAdarTxDetails_base {
  readonly HashType: typeof HashType;
  private account;
  readonly transaction: HistoryItem;
  pageAmount: number;
  get isAdarOperation(): boolean;
  get swapTransferBatchRecipients(): any;
  get txsList(): any[];
  get numberOfRecipients(): any;
