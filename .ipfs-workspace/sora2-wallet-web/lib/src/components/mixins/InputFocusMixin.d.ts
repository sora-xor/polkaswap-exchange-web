declare const InputFocusMixin_base: import('vue-class-component').VueConstructor<
  {
...
>;
export default class InputFocusMixin extends InputFocusMixin_base {
  readonly autofocus: boolean;
  readonly input: any;
  mounted(): void;
  activated(): void;
  focusCheck(): Promise<void>;
  focus(): void;
}
export {};
