...
declare const AccountConnectionList_base: import('vue-class-component').VueConstructor<
  TranslationMixin & {
...
>;
export default class AccountConnectionList extends AccountConnectionList_base {
  private accounts;
  private wallet;
  private isConnected;
  readonly chainApi: WithConnectionApi;
  get accountList(): {
