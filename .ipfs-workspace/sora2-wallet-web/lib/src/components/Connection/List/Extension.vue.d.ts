...
declare const ExtensionConnectionList_base: import('vue-class-component').VueConstructor<
  TranslationMixin & {
...
>;
export default class ExtensionConnectionList extends ExtensionConnectionList_base {
