...
describe('feature page import regressions', () => {
  it('uses direct Demeter page imports instead of lazy legacy wrappers', () => {
    ...
    expect(demeterPoolSource).toContain("import StatusBadge from '@/modules/staking/demeter/components/StatusBadge.vue';");
  ...
  it('uses the direct referral bonding page import', () => {
    expect(referralProgramSource).toContain("import ReferralBonding from '@/features/referrals/pages/ReferralBondingPage.vue';");
