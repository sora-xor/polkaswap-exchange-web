...
describe('wallet store migration', () => {
  ...
  it('routes wallet runtime access through Pinia facades', async () => {
    ...
    expect(sources.walletConnection).toContain("from '@/stores/router'");
    ...
    expect(sources.multisigCreateDialog).toContain("from '@/stores/router'");
    expect(sources.multisigCreateDialog).toContain("from '@/stores/wallet'");
    expect(sources.mstOnboardingDialog).toContain("from '@/stores/router'");
    expect(sources.mstOnboardingDialog).toContain("from '@/stores/settings'");
    expect(sources.multisigChangeNameDialog).toContain("from '@/stores/router'");
