...
import { useDialogVisibility } from '@/lib/soraneo-wallet/src/composables/useDialog';

describe('wallet useDialogVisibility', () => {
  it('syncs internal visibility from the prop ref and reacts to external updates', async () => {
