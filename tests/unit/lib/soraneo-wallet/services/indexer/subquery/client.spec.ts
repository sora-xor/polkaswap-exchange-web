...
const mocks = vi.hoisted(() => ({
  ...
  subscriptionClientCtorMock: vi.fn(function MockSubscriptionClient() {
...
vi.mock('subscriptions-transport-ws', () => ({
  SubscriptionClient: mocks.subscriptionClientCtorMock,
}));
...
describe('subquery createExplorerClient', () => {
  beforeEach(() => {
    ...
    mocks.subscriptionClientCtorMock.mockClear();
  });
