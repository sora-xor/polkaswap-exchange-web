...
describe('TokenPriceChart source', () => {
  it('uses direct shared component imports instead of the lazy registry', () => {
    ...
    expect(tokenPriceChartSource).toContain("import SelectToken from '@/components/shared/SelectAsset/SelectToken.vue';");
    expect(tokenPriceChartSource).toContain("import TokenSelectButton from '@/components/shared/Input/TokenSelectButton.vue';");
    expect(tokenPriceChartSource).toContain("import PriceChartWidget from '@/components/shared/Widget/PriceChart.vue';");
  });
});
