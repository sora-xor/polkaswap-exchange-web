 ...
 * ```
 */
export declare function preimages(
  instanceId: string,
  api: DeriveApi
): (
  hashes: (Hash | Uint8Array | string | FrameSupportPreimagesBounded)[]
) => Observable<(DeriveProposalImage | undefined)[]>;
/**
 * @name preimage
 ...
 * ```
 */
export declare const preimage: (
  instanceId: string,
  api: DeriveApi
) => (hash: string | Uint8Array | Hash | FrameSupportPreimagesBounded) => Observable<DeriveProposalImage | undefined>;
