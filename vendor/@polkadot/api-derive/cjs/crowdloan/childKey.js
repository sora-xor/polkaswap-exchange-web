...
function createChildKey(info) {
  return (0, util_1.u8aToHex)(
    (0, util_1.u8aConcat)(
      ...
      (0, util_crypto_1.blake2AsU8a)((0, util_1.u8aConcat)('crowdloan', (info.fundIndex || info.trieIndex).toU8a()))
    )
  );
}
/**
...
function childKey(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, (paraId) =>
    api.query['crowdloan']
      ['funds'](paraId)
      .pipe((0, rxjs_1.map)((optInfo) => (optInfo.isSome ? createChildKey(optInfo.unwrap()) : null)))
  );
}
