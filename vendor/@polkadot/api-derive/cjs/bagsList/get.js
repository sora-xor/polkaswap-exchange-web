...
function all(instanceId, api) {
  ...
  return (0, index_js_1.memo)(instanceId, () =>
    query.listBags.keys().pipe(
      (0, rxjs_1.switchMap)((keys) => api.derive.bagsList._getIds(keys.map(({ args: [id] }) => id))),
      (0, rxjs_1.map)((list) => list.filter(({ bag }) => bag))
    )
  );
}
/**
...
function get(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, (id) =>
    api.derive.bagsList._getIds([(0, util_1.bnToBn)(id)]).pipe((0, rxjs_1.map)((bags) => bags[0]))
  );
}
