...
function expand(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, (bag) =>
    api.derive.bagsList.listNodes(bag.bag).pipe((0, rxjs_1.map)((nodes) => (0, util_1.objectSpread)({ nodes }, bag)))
  );
}
/**
 * @name getExpanded
...
function getExpanded(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, (id) =>
    api.derive.bagsList.get(id).pipe((0, rxjs_1.switchMap)((bag) => api.derive.bagsList.expand(bag)))
  );
}
