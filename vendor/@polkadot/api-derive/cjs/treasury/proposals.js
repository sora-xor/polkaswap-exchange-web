...
function retrieveProposals(api, proposalCount, approvalIds) {
  ...
  return (0, rxjs_1.combineLatest)([
    ...
    api.derive.council ? api.derive.council.proposals() : (0, rxjs_1.of)([]),
  ]).pipe(
    (0, rxjs_1.map)(([allProposals, councilProposals]) =>
...
function proposals(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, () =>
    api.query.treasury
      ? (0, rxjs_1.combineLatest)([api.query.treasury.proposalCount(), api.query.treasury.approvals()]).pipe(
          (0, rxjs_1.switchMap)(([proposalCount, approvalIds]) => retrieveProposals(api, proposalCount, approvalIds))
        )
      : (0, rxjs_1.of)({
          approvals: [],
