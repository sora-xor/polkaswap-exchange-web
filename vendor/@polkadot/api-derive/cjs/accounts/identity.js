...
function _identity(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, (accountId) =>
    accountId && api.query.identity?.identityOf
      ? (0, rxjs_1.combineLatest)([api.query.identity.identityOf(accountId), api.query.identity.superOf(accountId)])
...
function identity(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, (accountId) =>
    api.derive.accounts._identity(accountId).pipe(
      (0, rxjs_1.switchMap)(([identityOfOpt, superOfOpt]) => getParent(api, identityOfOpt, superOfOpt)),
      (0, rxjs_1.map)(([identityOfOpt, superOf]) => extractIdentity(identityOfOpt, superOf)),
      (0, rxjs_1.switchMap)((identity) => getSubIdentities(identity, api, accountId))
    )
  );
}
...
function hasIdentityMulti(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, (accountIds) =>
    api.query.identity?.identityOf
      ? (0, rxjs_1.combineLatest)([
          ...
          (0, rxjs_1.map)(([identities, supers]) =>
