...
function votesPrev(api, referendumId) {
  return api.query.democracy['votersFor'](referendumId).pipe(
    ...
    (0, rxjs_1.map)(([votersFor, votes, balances]) =>
...
function _referendumVotes(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, (referendum) =>
    (0, rxjs_1.combineLatest)([
...
function _referendumsVotes(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, (referendums) =>
    referendums.length
...
function referendumsInfo(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, (ids) =>
    ids.length
      ? api.query.democracy.referendumInfoOf.multi(ids).pipe(
          (0, rxjs_1.switchMap)((infos) =>
            (0, rxjs_1.combineLatest)(ids.map((id, index) => api.derive.democracy._referendumInfo(id, infos[index])))
          ),
          (0, rxjs_1.map)((infos) => infos.filter((r) => !!r))
        )
      : (0, rxjs_1.of)([])
  );
}
