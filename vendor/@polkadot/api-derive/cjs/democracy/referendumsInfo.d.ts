...
export declare function _referendumVotes(
  instanceId: string,
  api: DeriveApi
): (referendum: DeriveReferendum) => Observable<DeriveReferendumVotes>;
export declare function _referendumsVotes(
  instanceId: string,
  api: DeriveApi
): (referendums: DeriveReferendum[]) => Observable<DeriveReferendumVotes[]>;
export declare function _referendumInfo(
  instanceId: string,
  api: DeriveApi
): (
  index: BN,
  info: Option<PalletDemocracyReferendumInfo | ReferendumInfoTo239>
) => Observable<DeriveReferendum | null>;
/**
 ...
 * ```
 */
export declare function referendumsInfo(
  instanceId: string,
  api: DeriveApi
