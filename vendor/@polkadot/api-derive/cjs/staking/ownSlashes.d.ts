...
export declare function _ownSlashes(
  instanceId: string,
  api: DeriveApi
 ...
 * ```
 */
export declare const ownSlash: (
  instanceId: string,
  api: DeriveApi
) => (accountId: string | Uint8Array, era: EraIndex) => Observable<DeriveStakerSlashes>;
/**
 * @name ownSlashes
 ...
 * ```
 */
export declare const ownSlashes: (
  instanceId: string,
  api: DeriveApi
) => (accountId: string | Uint8Array, withActive?: boolean) => Observable<DeriveStakerSlashes[]>;
