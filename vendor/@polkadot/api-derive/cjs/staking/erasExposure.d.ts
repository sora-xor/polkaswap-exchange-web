 ...
 */
export declare function _eraExposure(
  instanceId: string,
  api: DeriveApi
): (era: EraIndex, withActive?: boolean) => Observable<DeriveEraExposurePaged>;
/**
 * @name eraExposure
 ...
 * ```
 */
export declare const eraExposure: (
  instanceId: string,
  api: DeriveApi
) => (era: EraIndex) => Observable<DeriveEraExposurePaged>;
export declare const _erasExposure: (
  instanceId: string,
  api: DeriveApi
) => (eras: EraIndex[], withActive: boolean) => Observable<DeriveEraExposurePaged[]>;
/**
 * @name erasExposure
 ...
 * ```
 */
export declare const erasExposure: (
  instanceId: string,
  api: DeriveApi
) => (withActive?: boolean) => Observable<DeriveEraExposurePaged[]>;
