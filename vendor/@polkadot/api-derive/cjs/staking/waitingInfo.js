...
function waitingInfo(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, (flags = DEFAULT_FLAGS) =>
    (0, rxjs_1.combineLatest)([api.derive.staking.validators(), api.derive.staking.stashes()]).pipe(
      (0, rxjs_1.switchMap)(([{ nextElected }, stashes]) => {
