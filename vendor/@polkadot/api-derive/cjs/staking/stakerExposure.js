...
function stakerExposures(instanceId, api) {
  return (0, index_js_1.memo)(instanceId, (accountIds, withActive = false) =>
    api.derive.staking
      ...
      .pipe((0, rxjs_1.switchMap)((eras) => api.derive.staking._stakerExposures(accountIds, eras, withActive)))
  );
}
/**
 * @name stakerExposure
 ...
 * ```
 */
exports.stakerExposure = (0, index_js_1.firstMemo)((api, accountId, withActive) =>
