 ...
 * ```
 */
export declare function extrinsicInfo(
  instanceId: string,
  api: DeriveApi
): (at: Hash, transactionHash: Uint8Array | string) => Observable<ExtrinsicInfo | null>;
/**
 ...
 * ```
 */
export declare function accountExtrinsics(
  instanceId: string,
  api: DeriveApi
): (at: Hash, accountId: Uint8Array | string) => Observable<ExtrinsicsInfo>;
export {};
