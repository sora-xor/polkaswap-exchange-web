...
export declare function _identity(
  instanceId: string,
  api: DeriveApi
): (
  ...
  [
    Option<ITuple<[PalletIdentityRegistration, Option<Bytes>]>> | Option<PalletIdentityRegistration> | undefined,
    Option<ITuple<[AccountId, Data]>> | undefined,
  ]
>;
/**
 * @name identity
...
export declare function identity(
  instanceId: string,
  api: DeriveApi
): (accountId?: AccountId | Uint8Array | string) => Observable<DeriveAccountRegistration>;
/**
 * @name hasIdentity
 ...
 * ```
 */
export declare const hasIdentity: (
  instanceId: string,
  api: DeriveApi
) => (accountId: string | AccountId | Uint8Array) => Observable<DeriveHasIdentity>;
/**
 ...
 * ```
 */
export declare function hasIdentityMulti(
  instanceId: string,
  api: DeriveApi
