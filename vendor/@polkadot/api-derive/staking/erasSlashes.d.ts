...
export declare function _eraSlashes(
  instanceId: string,
  api: DeriveApi
 ...
 * ```
 */
export declare const eraSlashes: (
  instanceId: string,
  api: DeriveApi
) => (era: EraIndex) => Observable<DeriveEraSlashes>;
export declare const _erasSlashes: (
  instanceId: string,
  api: DeriveApi
 ...
 * ```
 */
export declare const erasSlashes: (
  instanceId: string,
  api: DeriveApi
) => (withActive?: boolean) => Observable<DeriveEraSlashes[]>;
