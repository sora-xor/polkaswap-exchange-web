...
export declare function _stakerExposures(
  instanceId: string,
  api: DeriveApi
): (
  ...
  eras: EraIndex[],
  withActive?: boolean
) => Observable<DeriveStakerExposure[][]>;
/**
 ...
 * ```
 */
export declare function stakerExposures(
  instanceId: string,
  api: DeriveApi
 ...
 * ```
 */
export declare const stakerExposure: (
  instanceId: string,
  api: DeriveApi
) => (accountId: string | Uint8Array, withActive?: boolean | undefined) => Observable<DeriveStakerExposure[]>;
