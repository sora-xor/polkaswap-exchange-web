...
export declare function _ownExposures(
  instanceId: string,
  api: DeriveApi
): (
 ...
 * ```
 */
export declare const ownExposure: (
  instanceId: string,
  api: DeriveApi
) => (
  accountId: string | Uint8Array,
  era: EraIndex,
  page?: u32 | AnyNumber | undefined
) => Observable<DeriveOwnExposure>;
/**
 * @name ownExposures
 ...
 * ```
 */
export declare const ownExposures: (
  instanceId: string,
  api: DeriveApi
) => (accountId: string | Uint8Array, withActive?: boolean) => Observable<DeriveOwnExposure[]>;
