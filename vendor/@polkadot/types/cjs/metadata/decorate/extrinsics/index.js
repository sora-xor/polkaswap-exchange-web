...
function createCallFunction(registry, lookup, variant, sectionName, sectionIndex) {
  ...
  return (0, _createUnchecked.createUnchecked)(
    registry,
    sectionName,
...
function decorateExtrinsics(registry, _ref2, version) {
  ...
  for (let i = 0; i < filtered.length; i++) {
    ...
    (0, _util.lazyMethod)(result, sectionName, () =>
      (0, _lazy.lazyVariants)(lookup, calls.unwrap(), _util3.objectNameToCamel, (variant) =>
