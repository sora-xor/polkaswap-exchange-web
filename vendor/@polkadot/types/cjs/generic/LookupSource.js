...
function decodeString(registry, value) {
  ...
  return decoded.length === 32
    ...
    : registry.createTypeUnsafe('AccountIndex', [(0, _util.u8aToBn)(decoded)]);
}
...
function decodeAddressOrIndex(registry, value) {
  return value instanceof GenericLookupSource
    ? value.inner
    : value instanceof _AccountId.GenericAccountId || value instanceof _AccountIndex.GenericAccountIndex
      ? value
      : (0, _util.isBn)(value) || (0, _util.isNumber)(value) || (0, _util.isBigInt)(value)
        ? registry.createTypeUnsafe('AccountIndex', [value])
        : Array.isArray(value) || (0, _util.isHex)(value) || (0, _util.isU8a)(value)
          ? decodeU8a(registry, (0, _util.u8aToU8a)(value))
...
class GenericLookupSource extends _typesCodec.AbstractBase {
   ...
   */
  get _rawLength() {
    return this.inner instanceof _AccountIndex.GenericAccountIndex
      ? _AccountIndex.GenericAccountIndex.calcLength(this.inner)
  ...
  inspect() {
    ...
    return {
      outer: [
        new Uint8Array(
          this.inner instanceof _AccountIndex.GenericAccountIndex
            ? _AccountIndex.GenericAccountIndex.writeLength(value)
            : ACCOUNT_ID_PREFIX
        ),
        value,
      ],
  ...
  toU8a(isBare) {
    ...
    return isBare
      ...
      : (0, _util.u8aConcat)(
          this.inner instanceof _AccountIndex.GenericAccountIndex
            ? _AccountIndex.GenericAccountIndex.writeLength(encoded)
            : ACCOUNT_ID_PREFIX,
          encoded
        );
  }
