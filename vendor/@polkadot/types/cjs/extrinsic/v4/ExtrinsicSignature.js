...
class GenericExtrinsicSignatureV4 extends _typesCodec.Struct {
  ...
  constructor(registry, value) {
    let { isSigned } = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  ...
  addSignature(signer, signature, payload) {
    return this._injectSignature(
      ...
      new _ExtrinsicPayload.GenericExtrinsicPayloadV4(this.registry, payload)
    );
  }
  ...
  createPayload(method, options) {
    ...
    return new _ExtrinsicPayload.GenericExtrinsicPayloadV4(
      this.registry,
