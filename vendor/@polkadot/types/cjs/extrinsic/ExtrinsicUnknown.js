...
class GenericExtrinsicUnknown extends _typesCodec.Struct {
  constructor(registry, value) {
    let { isSigned = false, version = 0 } = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    super(registry, {});
    throw new Error(
      `Unsupported ${isSigned ? '' : 'un'}signed extrinsic version ${version & _constants.UNMASK_VERSION}`
    );
  }
}
