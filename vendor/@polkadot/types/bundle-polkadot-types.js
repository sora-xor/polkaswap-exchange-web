(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
        factory((global.polkadotTypes = {}), global.polkadotUtil, global.polkadotUtilCrypto));
})(this, function (exports, util, utilCrypto) {
  'use strict';
  ...
  const runtime$i = {
    BlockBuilder: [
      ...
      {
        methods: util.objectSpread({}, BB_V2_TO_V5, BB_V2_TO_V6, BB_V3_TO_V6),
        version: 5,
      },
      {
        methods: util.objectSpread({}, BB_V2_TO_V4, BB_V2_TO_V5, BB_V2_TO_V6, BB_V3_TO_V6),
        version: 4,
      },
      {
        methods: util.objectSpread({}, BB_V2_TO_V4, BB_V2_TO_V6, BB_V3_TO_V6),
        version: 3,
      },
      {
        methods: util.objectSpread(
  ...
  const AllConvictions = ['None', 'Locked1x', 'Locked2x', 'Locked3x', 'Locked4x', 'Locked5x', 'Locked6x'];
  const definitions$S = {
    rpc: {},
    types: {
      AccountVote: {
  ...
  function compareArray(a, b) {
    if (Array.isArray(b)) {
      return (
        a.length === b.length && util.isUndefined(a.find((v, index) => (hasEq(v) ? !v.eq(b[index]) : v !== b[index])))
      );
    }
    return false;
  }
  ...
  class AbstractInt extends util.BN {
    ...
    constructor(registry, value = 0, bitLength = DEFAULT_UINT_BITS, isSigned = false) {
      super(
        util.isU8a(value)
          ? bitLength <= 48
            ? util.u8aToNumber(value.subarray(0, bitLength / 8), {
                isNegative: isSigned,
              })
            : util
      ...
      if (isNegative && !isSigned) {
        ...
        throw new Error(
          `${this.toRawType()}: Input too large. Found input with ${super.bitLength()} bits, expected ${maxBits}`
        );
      }
    }
    get hash() {
  ...
  function decodeU8a$6(registry, result, u8a, [Types, keys]) {
    ...
    try {
      ...
      throw new Error(
        formatFailure(registry, 'decodeU8a', result, error, u8a.subarray(offset), i, count, Types[i], keys[i])
      );
    }
  ...
  function decodeU8aStruct(registry, result, u8a, [Types, keys]) {
    ...
    try {
      ...
      throw new Error(
        formatFailure(registry, 'decodeU8aStruct', result, error, u8a.subarray(offset), i, count, Types[i], keys[i])
      );
    }
    return [result, offset];
  }
  ...
  function sortAsc(a, b) {
    ...
    throw new Error(
      `Attempting to sort unrecognized values: ${util.stringify(a)} (typeof ${typeof a}) <-> ${util.stringify(b)} (typeof ${typeof b})`
    );
  }
  ...
  class Enum {
    ...
    constructor(registry, Types, value, index, { definition, setDefinition = noopSetDefinition$5 } = {}) {
      ...
      const decoded =
        util.isU8a(value) && value.length && !util.isNumber(index)
    ...
    toU8a(isBare) {
      return isBare
        ...
        : util.u8aConcatStrict([new Uint8Array([this.index]), this.#raw.toU8a(isBare)]);
    }
  }
  ...
  class Option {
    ...
    constructor(registry, typeName, value, { definition, setDefinition = noopSetDefinition$4 } = {}) {
      ...
      const decoded =
        util.isU8a(value) && value.length && !util.isCodec(value)
          ? value[0] === 0
            ? new None(registry)
  ...
  class Tuple extends AbstractArray {
    ...
    constructor(registry, Types, value, { definition, setDefinition = noopSetDefinition$3 } = {}) {
      ...
      this.initialU8aLength = (
        util.isU8a(value) ? decodeU8a$6(registry, this, value, Classes) : decodeTuple(registry, this, value, Classes)
      )[1];
      this.#Types = Classes;
    }
    static with(Types) {
  ...
  function decodeStructFromObject(registry, [Types, keys], value, jsonMap) {
    ...
    if (!typeofArray && !typeofMap && !util.isObject(value)) {
      throw new Error(
        `Struct: Cannot decode value ${util.stringify(value)} (typeof ${typeof value}), expected an input object, map or array`
      );
    } else if (typeofArray && value.length !== keys.length) {
      throw new Error(
        `Struct: Unable to map ${util.stringify(value)} array to object with known keys ${keys.join(', ')}`
      );
    }
  ...
  class Struct extends Map {
    ...
    constructor(registry, Types, value, jsonMap = new Map(), { definition, setDefinition = noopSetDefinition } = {}) {
      ...
      const [decoded, decodedLength] =
        util.isU8a(value) || util.isHex(value)
  ...
  function decodeMapFromMap(registry, KeyClass, ValClass, value) {
    ...
    for (const [key, val] of value.entries()) {
      const isComplex =
        KeyClass.prototype instanceof AbstractArray ||
      ...
      try {
        output.set(
          ...
          val instanceof ValClass ? val : new ValClass(registry, val)
        );
      } catch (error) {
  ...
  class Bytes extends Raw {
    constructor(registry, value) {
      const [u8a, decodedLength] =
        util.isU8a(value) && !(value instanceof Raw)
  ...
  class OptionBool extends Option {
    constructor(registry, value) {
      super(
        registry,
        bool,
        util.isU8a(value) || util.isHex(value) ? decodeU8a$5(registry, util.u8aToU8a(value)) : value
      );
    ...
    constructor(registry, value, { bitLength = 32 } = {}) {
      super(
        util.isU8a(value) || util.isHex(value)
          ? value.length === 0
            ? 0
            : util.u8aToFloat(util.u8aToU8a(value), {
                bitLength,
              })
          : value || 0
      );
  ...
  function decodeSet(setValues, value = 0, bitLength) {
    ...
    if (util.isU8a(value)) {
      return value.length === 0
        ...
        : decodeSetNumber(
            setValues,
            util.u8aToBn(value.subarray(0, byteLength), {
              isLe: true,
            })
          );
    } else if (util.isString(value)) {
  ...
  function _decodeEnum(value, details, count, fallbackType) {
    ...
    if (Array.isArray(details)) {
      ...
      value.sub = Object.entries(details).map(([name, typeOrObj], index) =>
        util.objectSpread(
          {},
          getTypeDef(
            getTypeString(typeOrObj || 'Null'),
            {
              name,
            },
            count
  ...
  function _decodeSet(value, details, fallbackType) {
    ...
    value.sub = Object.entries(details)
  ...
  function checkInstance(created, matcher) {
    ...
    if (!isOk) {
      throw new Error(
        `${rawType}:: Decoded input doesn't match input, received ${util.u8aToHex(matcher, 512)} (${matcher.length} bytes), created ${util.u8aToHex(u8a, 512)} (${u8a.length} bytes)`
      );
    }
  }
  ...
  const encoders = {
    ...
    [exports.TypeDefInfo.DoNotConstruct]: (registry, { displayName, lookupIndex, lookupName }) =>
    ...
    [exports.TypeDefInfo.Struct]: (registry, { alias, sub }) => {
      ...
      return encodeSubTypes(
        registry,
        sub,
        false,
        alias
          ? {
              _alias: [...alias.entries()].reduce(
                (all, [k, v]) =>
                  util.objectSpread(all, {
                    [k]: v,
                  }),
    ...
    [exports.TypeDefInfo.WrapperKeepOpaque]: (registry, typeDef) =>
  ...
  const jsonrpc = {};
  Object.keys(definitions).forEach((s) =>
    Object.entries(definitions[s].rpc || {}).forEach(([method, def]) => {
  ...
  class GenericEventData extends Tuple {
    ...
    constructor(registry, value, meta, section = '<unknown>', method = '<unknown>') {
      ...
      super(
        registry,
        fields.map(({ type }) => registry.createLookupType(type)),
        value
      );
      this.#meta = meta;
      this.#method = method;
  ...
  const VERSIONS$1 = ['ExtrinsicUnknown', 'ExtrinsicUnknown', 'ExtrinsicUnknown', 'ExtrinsicUnknown', 'ExtrinsicV4'];
  ...
  class MortalEra extends Tuple {
    ...
    toU8a(isBare) {
      ...
      const encoded =
        ...
        ((this.phase.toNumber() / Math.max(period >> 12, 1)) << 4);
  ...
  class GenericSignerPayload extends Struct {
    #extraTypes;
    constructor(registry, value) {
      const extensionTypes = util.objectSpread(
        {},
  ...
  class GenericExtrinsicSignatureV4 extends Struct {
    ...
    createPayload(method, options) {
      ...
      return new GenericExtrinsicPayloadV4(
        this.registry,
  ...
  class GenericEthereumLookupSource extends AbstractBase {
    ...
    toU8a(isBare) {
      ...
      return isBare
        ? encoded
        : util.u8aConcat(
            this.inner instanceof GenericAccountIndex ? GenericAccountIndex.writeLength(encoded) : ACCOUNT_ID_PREFIX$1,
            encoded
          );
    }
  }
  ...
  class GenericCall extends Struct {
    ...
    toHuman(isExpanded) {
      ...
      return util.objectSpread(
        {
          args: this.argsEntries.reduce(
            (args, [n, a]) =>
              util.objectSpread(args, {
  ...
  function createValue(registry, type, value, asArray = true) {
    ...
    return registry.createTypeUnsafe(type, [
      asArray ? (util.isNull(value) || util.isUndefined(value) ? null : Array.isArray(value) ? value : [value]) : value,
    ]);
  }
  ...
  function decode(registry, value) {
    return (value && util.isFunction(value.entries) ? [...value.entries()] : Object.entries(value || {})).reduce(
      (all, [key, value]) => {
  ...
  function getAuraAuthor(registry, bytes, sessionValidators) {
    return sessionValidators[
      registry
        .createTypeUnsafe('RawAuraPreDigest', [bytes.toU8a(true)])
        .slotNumber.mod(new util.BN(sessionValidators.length))
        .toNumber()
    ];
  }
  ...
  class GenericLookupSource extends AbstractBase {
    ...
    inspect() {
      ...
      return {
        outer: [
          new Uint8Array(
            this.inner instanceof GenericAccountIndex ? GenericAccountIndex.writeLength(value) : ACCOUNT_ID_PREFIX
          ),
          value,
        ],
      };
    ...
    toU8a(isBare) {
      ...
      return isBare
        ? encoded
        : util.u8aConcat(
            this.inner instanceof GenericAccountIndex ? GenericAccountIndex.writeLength(encoded) : ACCOUNT_ID_PREFIX,
            encoded
          );
    }
  }
  ...
  function decodeVoteType(registry, value) {
    return new Uint8Array([
      (new bool(registry, value.aye).isTrue ? AYE_BITS : NAY_BITS) |
  ...
  function validateTypes(registry, throwError, types) {
    const missing = flattenUniq(extractTypes$1(types))
      .filter((type) => !registry.hasType(type) && !registry.isLookupType(type))
      .sort();
    if (missing.length !== 0) {
  ...
  function getPalletNames({ lookup, pallets }) {
    return pallets.reduce((all, { calls, constants, events, storage }) => {
      ...
      if (storage.isSome) {
        all.push(
          storage.unwrap().items.map(({ type }) => {
            if (type.isPlain) {
              return [lookup.getTypeDef(type.asPlain).type];
            }
            const { hashers, key, value } = type.asMap;
            return hashers.length === 1
              ? [lookup.getTypeDef(value).type, lookup.getTypeDef(key).type]
              : [
  ...
  function decodeArgsFromMeta(registry, value, meta) {
    ...
    return decodeHashers(
      registry,
      value,
      hashers.map((h, i) => [h, keys[i]])
    );
  }
  ...
  function createStorageType(registry, entryType) {
    if (entryType.isMap) {
      return [
        util.objectSpread({}, entryType.asMap, {
    ...
    if (entryType.isDoubleMap) {
      return [
        util.objectSpread({}, entryType.asDoubleMap, {
  ...
  function getAliasTypes({ knownTypes }, section) {
    ...
    return util.objectSpread(
      {},
      typesAlias[section],
      (_knownTypes$typesAlia = knownTypes.typesAlias) == null ? void 0 : _knownTypes$typesAlia[section]
    );
  }
  ...
  function registerOriginCaller(registry, modules, metaVersion) {
    registry.register({
      OriginCaller: {
        _enum: modules
          .map((mod, index) => [mod.name.toString(), metaVersion >= 12 ? mod.index.toNumber() : index])
          .sort((a, b) => a[1] - b[1])
  ...
  function setTypeOverride(sectionTypes, types) {
    types.forEach((type) => {
      ...
      if (override) {
        ...
        const alias = Object.entries(sectionTypes).reduce(
          (result, [src, dst]) =>
            BOXES.reduce((result, [a, z]) => result.replace(`${a}${src}${z}`, `${a}${dst}${z}`), result),
          orig
        );
        if (orig !== alias) {
  ...
  function convertErrors(specs, registry, modName, errors, _sectionTypes) {
    const variants = errors.map(({ docs, name }, index) =>
        ...
        Map: {
          ...
          key:
            hashers.length === 1
              ...
              : makeTupleType(
                  specs,
                  keys.map((t) => compatType(specs, t))
                ),
          value: isLinked
            ? compatType(
                specs,
                `(${isOptional ? `Option<${value.toString()}>` : value.toString()}, Linkage<${keys[0].toString()}>)`
              )
  ...
  function decorateConstants(registry, { pallets }, _version) {
    ...
    for (let i = 0; i < pallets.length; i++) {
      ...
      if (!constants.isEmpty) {
        util.lazyMethod(result, util.stringCamelCase(name), () =>
          util.lazyMethods(
            {},
            constants,
            (constant) => {
              const codec = registry.createTypeUnsafe(registry.createLookupType(constant.type), [
                util.hexToU8a(constant.value.toHex()),
              ]);
              codec.meta = constant;
              return codec;
            },
  ...
  function decorateErrors(registry, { lookup, pallets }, version) {
    ...
    for (let i = 0; i < pallets.length; i++) {
      ...
      if (errors.isSome) {
        ...
        util.lazyMethod(result, util.stringCamelCase(name), () =>
          lazyVariants(lookup, errors.unwrap(), objectNameToString, (variant) => ({
            is: (errorMod) =>
              util.isCodec(errorMod) &&
              util.isCodec(errorMod.index) &&
              errorMod.index.eq(sectionIndex) &&
              (util.isU8a(errorMod.error)
  ...
  function decorateEvents(registry, { lookup, pallets }, version) {
    ...
    for (let i = 0; i < filtered.length; i++) {
      ...
      const sectionIndex = version >= 12 ? index.toNumber() : i;
      util.lazyMethod(result, util.stringCamelCase(name), () =>
        lazyVariants(lookup, events.unwrap(), objectNameToString, (variant) => ({
          is: (eventRecord) =>
            util.isCodec(eventRecord) &&
  ...
  function decorateExtrinsics(registry, { lookup, pallets }, version) {
    ...
    for (let i = 0; i < filtered.length; i++) {
      ...
      const sectionIndex = version >= 12 ? index.toNumber() : i;
      util.lazyMethod(result, sectionName, () =>
        lazyVariants(lookup, calls.unwrap(), objectNameToCamel, (variant) =>
  ...
  const HASHERS = {
    Blake2_128: (data) => utilCrypto.blake2AsU8a(data, 128),
    Blake2_128Concat: (data) => util.u8aConcat(utilCrypto.blake2AsU8a(data, 128), util.u8aToU8a(data)),
    Blake2_256: (data) => utilCrypto.blake2AsU8a(data, 256),
  ...
  function assertArgs({ method, section }, { args, keys }) {
    if (!Array.isArray(args)) {
      throw new Error(
        `Call to ${util.stringCamelCase(section || 'unknown')}.${util.stringCamelCase(method || 'unknown')} needs ${keys.length} arguments`
      );
    } else if (args.filter(filterDefined).length !== keys.length) {
      throw new Error(
        `Call to ${util.stringCamelCase(section || 'unknown')}.${util.stringCamelCase(method || 'unknown')} needs ${keys.length} arguments, found [${args.join(', ')}]`
      );
    }
  }
    ...
    if (meta.type.isMap) {
      ...
      types =
        hashers.length === 1
          ...
          : registry.lookup
              .getSiType(key)
              .def.asTuple.map((k, i) => `${hashers[i].type}(${getSiName(registry.lookup, k)})`);
    }
  ...
  function extendHeadMeta(registry, { meta: { docs, name, type }, section }, { method }, iterFn) {
    ...
    iterFn.meta = meta;
    const fn = (...args) =>
      registry.createTypeUnsafe('StorageKey', [
        iterFn(...args),
        {
          method,
          section,
  ...
  function extendPrefixedMap(registry, itemFn, storageFn) {
    ...
    storageFn.iterKey = extendHeadMeta(registry, itemFn, storageFn, (...args) => {
      if (args.length && (type.isPlain || args.length >= type.asMap.hashers.length)) {
        throw new Error(
          `Iteration of ${util.stringCamelCase(section || 'unknown')}.${util.stringCamelCase(method || 'unknown')} needs arguments to be at least one less than the full arguments, found [${args.join(', ')}]`
        );
      }
      if (args.length) {
        if (type.isMap) {
  ...
  function createFunction(registry, itemFn, options) {
    ...
    storageFn.keyPrefix = (...args) =>
      (storageFn.iterKey && storageFn.iterKey(...args)) || util.compactStripLength(storageFn())[1];
    return storageFn;
  }

  function findSiPrimitive(registry, _prim) {
    const prim = _prim.toLowerCase();
    return registry.lookup.types.find(
      (t) =>
        (t.type.def.isPrimitive && t.type.def.asPrimitive.toString().toLowerCase() === prim) ||
        (t.type.def.isHistoricMetaCompat && t.type.def.asHistoricMetaCompat.toString().toLowerCase() === prim)
    );
  }
  function findSiType(registry, orig) {
    ...
    if (!portable && orig === 'Bytes') {
      ...
      if (u8) {
        portable = registry.lookup.types.find(
          (t) =>
            (t.type.def.isSequence && t.type.def.asSequence.type.eq(u8.id)) ||
            (t.type.def.isHistoricMetaCompat && t.type.def.asHistoricMetaCompat.eq(orig))
        );
      }
    }
    if (!portable) {
  ...
  const RESERVED = ['entries', 'keys', 'new', 'size', 'hash', 'registry'];
    ...
    return names
      .map((original, startAt) => {
        ...
        const paramIdx = params.findIndex(({ type }, index) =>
          allSame.every(
            ({ params }, aIndex) => params[index].type.isSome && (aIndex === 0 || !params[index].type.eq(type))
          )
        );
        if (paramIdx === -1) {
          return original;
  ...
  class PortableRegistry extends Struct {
    ...
    register() {
      registerTypes(
        this,
        _classPrivateFieldBase(this, _lookups)[_lookups],
        _classPrivateFieldBase(this, _names)[_names],
        _classPrivateFieldBase(this, _params)[_params]
      );
    }
    getName(lookupId) {
      return _classPrivateFieldBase(this, _names)[_names][
        _classPrivateFieldBase(this, _getLookupId)[_getLookupId](lookupId)
      ];
    }
    getSiType(lookupId) {
      const found = (_classPrivateFieldBase(this, _types)[_types] || this.types)[
        _classPrivateFieldBase(this, _getLookupId)[_getLookupId](lookupId)
      ];
      if (!found) {
    ...
    getTypeDef(lookupId) {
      ...
      if (!_classPrivateFieldBase(this, _typeDefs)[_typeDefs][lookupIndex]) {
        ...
        if (extracted.info === exports.TypeDefInfo.Plain) {
          _classPrivateFieldBase(this, _typeDefs)[_typeDefs][lookupIndex].lookupNameRoot = _classPrivateFieldBase(
            this,
            _typeDefs
          )[_typeDefs][lookupIndex].lookupName;
  ...
  function _createSiDef2(lookupId) {
    ...
    return [exports.TypeDefInfo.DoNotConstruct, exports.TypeDefInfo.Enum, exports.TypeDefInfo.Struct].includes(
      typeDef.info
    ) && typeDef.lookupName
      ? {
          docs: typeDef.docs,
  ...
  function _extract2(type, lookupIndex) {
    ...
    try {
      if (aliasType) {
        ...
        switch (type.def.type) {
          case 'Array':
            ...
            break;
          case 'BitSequence':
            typeDef = _classPrivateFieldBase(this, _extractBitSequence)[_extractBitSequence](
              lookupIndex,
          ...
          case 'Compact':
            ...
            break;
          case 'Composite':
            typeDef = _classPrivateFieldBase(this, _extractComposite)[_extractComposite](
              lookupIndex,
              type,
          ...
          case 'HistoricMetaCompat':
            typeDef = _classPrivateFieldBase(this, _extractHistoric)[_extractHistoric](
              lookupIndex,
          ...
          case 'Primitive':
            ...
            break;
          case 'Sequence':
            typeDef = _classPrivateFieldBase(this, _extractSequence)[_extractSequence](
              lookupIndex,
              type.def.asSequence
            );
            break;
          case 'Tuple':
            ...
            break;
          case 'Variant':
            typeDef = _classPrivateFieldBase(this, _extractVariant)[_extractVariant](
              lookupIndex,
              type,
              type.def.asVariant
            );
      ...
      throw new Error(
        `PortableRegistry: ${lookupIndex}${namespace ? ` (${namespace})` : ''}: Error extracting ${util.stringify(type)}: ${error.message}`
      );
    }
    return util.objectSpread(
      {
  ...
  function _extractComposite2(lookupIndex, { params, path }, { fields }) {
    if (path.length) {
      ...
      if (path.length === 1 && pathFirst === 'BTreeMap') {
        ...
        return withTypeString(this.registry, {
          ...
          sub: params.map(({ type }) => _classPrivateFieldBase(this, _createSiDef)[_createSiDef](type.unwrap())),
        });
    ...
    return PATHS_SET.some((p) => matchParts(p, path))
      ? _classPrivateFieldBase(this, _extractCompositeSet)[_extractCompositeSet](lookupIndex, params, fields)
      : _classPrivateFieldBase(this, _extractFields)[_extractFields](lookupIndex, fields);
  }
  ...
  function _extractFields2(lookupIndex, fields) {
    ...
    return withTypeString(
      ...
      util.objectSpread(
        {
          info: isTuple ? exports.TypeDefInfo.Tuple : exports.TypeDefInfo.Struct,
          sub,
        },
        alias.size
          ? {
  ...
  function _extractVariantEnum2(lookupIndex, variants) {
    ...
    variants
      ...
      .forEach(({ fields, index: bnIndex, name }) => {
        ...
        sub.push(
          util.objectSpread(_classPrivateFieldBase(this, _extractFields)[_extractFields](-1, fields), {
            index,
            name: name.toString(),
          })
        );
      ...
      registry.createType('PortableType', {
        ...
        type: {
          ...
          params: t.params.map((p) =>
            registry.createType('Si1TypeParameter', {
              type: p.toNumber(),
            })
          ),
  ...
  function injectErrors(_, { lookup, pallets }, version, result) {
    ...
    for (let i = 0; i < pallets.length; i++) {
      ...
      if (errors.isSome) {
        const sectionName = util.stringCamelCase(name);
        util.lazyMethod(result, version >= 12 ? index.toNumber() : i, () =>
          lazyVariants(lookup, errors.unwrap(), getVariantStringIdx, ({ docs, fields, index, name }) => ({
  ...
  function injectEvents(registry, { lookup, pallets }, version, result) {
    ...
    for (let i = 0; i < filtered.length; i++) {
      const { events, index, name } = filtered[i];
      util.lazyMethod(result, version >= 12 ? index.toNumber() : i, () =>
        lazyVariants(lookup, events.unwrap(), getVariantStringIdx, (variant) => {
          const meta = registry.createType(
            'EventMetadataLatest',
            util.objectSpread({}, variant, {
  ...
  function injectExtrinsics(registry, { lookup, pallets }, version, result, mapping) {
    ...
    for (let i = 0; i < filtered.length; i++) {
      ...
      util.lazyMethod(result, sectionIndex, () =>
        lazyVariants(lookup, allCalls, getVariantStringIdx, (variant) =>
          createCallFunction(registry, lookup, variant, sectionName, sectionIndex)
        )
      );
      ...
      if (palletIdx !== -1) {
        const name = util.stringCamelCase(
          path
            .slice(0, palletIdx)
            .map((p, i) => (i === 0 ? p.replace(/^(frame|pallet)_/, '') : p))
            .join(' ')
        );
        if (!mapping[name]) {
  ...
  class TypeRegistry {
    ...
    get chainSS58() {
      ...
      return (_this$chainProperties2 = this.#chainProperties) != null && _this$chainProperties2.ss58Format.isSome
    ...
    findMetaError(errorIndex) {
      const [section, method] = util.isU8a(errorIndex)
        ...
        : [
            ...
            util.isU8a(errorIndex.error) ? errorIndex.error[0] : errorIndex.error.toNumber(),
          ];
      return util.assertReturn(
    ...
    getModuleInstances(specName, moduleName) {
      var _this$knownTypes,
        _this$knownTypes$type,
        _this$knownTypes$type2,
        _this$knownTypes$type3,
        _this$knownTypes$type4;
      return (
        ((_this$knownTypes = this.#knownTypes) == null
          ? void 0
          : (_this$knownTypes$type = _this$knownTypes.typesBundle) == null
            ? void 0
            : (_this$knownTypes$type2 = _this$knownTypes$type.spec) == null
              ? void 0
              : (_this$knownTypes$type3 = _this$knownTypes$type2[specName.toString()]) == null
                ? void 0
                : (_this$knownTypes$type4 = _this$knownTypes$type3.instances) == null
                  ? void 0
                  : _this$knownTypes$type4[moduleName]) || this.#moduleMap[moduleName]
      );
    }
    getOrThrow(name) {
    ...
    setMetadata(metadata, signedExtensions, userExtensions) {
      ...
      this.setSignedExtensions(
        signedExtensions ||
          (this.#metadata.extrinsic.version.gt(util.BN_ZERO)
          ...
          typeof document === 'undefined' && typeof location === 'undefined'
            ...
            : typeof document === 'undefined'
              ...
              : (document.currentScript && document.currentScript.src) ||
                new URL('bundle-polkadot-types.js', document.baseURI).href,
      } &&
      (typeof document === 'undefined' && typeof location === 'undefined'
        ? new (require('u' + 'rl').URL)('file:' + __filename).href
        : typeof document === 'undefined'
