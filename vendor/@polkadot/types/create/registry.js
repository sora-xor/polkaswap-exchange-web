...
} from '../extrinsic/signedExtensions/index.js';
...
export class TypeRegistry {
  ...
  findMetaError(errorIndex) {
    const [section, method] = isU8a(errorIndex)
      ...
      : [errorIndex.index.toNumber(), isU8a(errorIndex.error) ? errorIndex.error[0] : errorIndex.error.toNumber()];
    return assertReturn(
