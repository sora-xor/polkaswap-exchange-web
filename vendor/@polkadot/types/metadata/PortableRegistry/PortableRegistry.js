...
export class PortableRegistry extends Struct {
  ...
  register() {
    registerTypes(
      this,
      _classPrivateFieldLooseBase(this, _lookups)[_lookups],
      _classPrivateFieldLooseBase(this, _names)[_names],
      _classPrivateFieldLooseBase(this, _params)[_params]
    );
  }
   ...
   */
  getName(lookupId) {
    return _classPrivateFieldLooseBase(this, _names)[_names][
      _classPrivateFieldLooseBase(this, _getLookupId)[_getLookupId](lookupId)
    ];
  }
  ...
  getSiType(lookupId) {
    ...
    const found = (_classPrivateFieldLooseBase(this, _types)[_types] || this.types)[
      _classPrivateFieldLooseBase(this, _getLookupId)[_getLookupId](lookupId)
    ];
    if (!found) {
  ...
  getTypeDef(lookupId) {
    ...
    if (!_classPrivateFieldLooseBase(this, _typeDefs)[_typeDefs][lookupIndex]) {
      ...
      if (extracted.info === TypeDefInfo.Plain) {
        _classPrivateFieldLooseBase(this, _typeDefs)[_typeDefs][lookupIndex].lookupNameRoot =
          _classPrivateFieldLooseBase(this, _typeDefs)[_typeDefs][lookupIndex].lookupName;
...
function _extract2(type, lookupIndex) {
  ...
  try {
    if (aliasType) {
      ...
      switch (type.def.type) {
        case 'Array':
          ...
          break;
        case 'BitSequence':
          typeDef = _classPrivateFieldLooseBase(this, _extractBitSequence)[_extractBitSequence](
            lookupIndex,
            type.def.asBitSequence
          );
          break;
        case 'Compact':
          typeDef = _classPrivateFieldLooseBase(this, _extractCompact)[_extractCompact](
            lookupIndex,
            type.def.asCompact
          );
          break;
        case 'Composite':
          typeDef = _classPrivateFieldLooseBase(this, _extractComposite)[_extractComposite](
            lookupIndex,
            type,
        ...
        case 'HistoricMetaCompat':
          typeDef = _classPrivateFieldLooseBase(this, _extractHistoric)[_extractHistoric](
            lookupIndex,
        ...
        case 'Primitive':
          ...
          break;
        case 'Sequence':
          typeDef = _classPrivateFieldLooseBase(this, _extractSequence)[_extractSequence](
            lookupIndex,
            type.def.asSequence
          );
          break;
        case 'Tuple':
          ...
          break;
        case 'Variant':
          typeDef = _classPrivateFieldLooseBase(this, _extractVariant)[_extractVariant](
            lookupIndex,
            type,
            type.def.asVariant
          );
    ...
    throw new Error(
      `PortableRegistry: ${lookupIndex}${namespace ? ` (${namespace})` : ''}: Error extracting ${stringify(type)}: ${error.message}`
    );
  }
  return objectSpread(
    {
...
function _extractComposite2(lookupIndex, { params, path }, { fields }) {
  if (path.length) {
    ...
    if (path.length === 1 && pathFirst === 'BTreeMap') {
      ...
      return withTypeString(this.registry, {
        ...
        sub: params.map(({ type }) => _classPrivateFieldLooseBase(this, _createSiDef)[_createSiDef](type.unwrap())),
      });
  ...
  return PATHS_SET.some((p) => matchParts(p, path))
    ? _classPrivateFieldLooseBase(this, _extractCompositeSet)[_extractCompositeSet](lookupIndex, params, fields)
    : _classPrivateFieldLooseBase(this, _extractFields)[_extractFields](lookupIndex, fields);
}
...
function _extractVariantEnum2(lookupIndex, variants) {
  ...
  variants
    ...
    .forEach(({ fields, index: bnIndex, name }) => {
      ...
      sub.push(
        objectSpread(_classPrivateFieldLooseBase(this, _extractFields)[_extractFields](-1, fields), {
          index,
          name: name.toString(),
        })
      );
