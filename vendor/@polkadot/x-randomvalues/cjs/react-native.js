...
function getRandomValuesRn(output) {
  if (!react_native_1.NativeModules['ExpoRandom'] && !react_native_1.NativeModules.RNGetRandomValues) {
    throw new Error(
      'No secure random number generator available. This environment does not support crypto.getRandomValues and no React Native secure RNG module is available.'
    );
  }
  return (0, base64_1.base64Decode)(
    react_native_1.NativeModules.RNGetRandomValues
...
exports.getRandomValues =
  typeof x_global_1.xglobal.crypto === 'object' && typeof x_global_1.xglobal.crypto.getRandomValues === 'function'
    ? browser_js_1.getRandomValues
    : typeof x_global_1.xglobal['nativeCallSyncHook'] === 'undefined'
      ? () => {
          throw new Error(
            'No secure random number generator available. This environment does not support crypto.getRandomValues.'
          );
        }
      : getRandomValuesRn;
exports.crypto =
  exports.getRandomValues === browser_js_1.getRandomValues
    ? browser_js_1.crypto
