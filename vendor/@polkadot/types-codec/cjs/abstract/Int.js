...
const FORMATTERS = [
  ['Perquintill', _util.BN_QUINTILL],
  ['Perbill', _util.BN_BILLION],
  ['Permill', _util.BN_MILLION],
  ['Percent', _util.BN_HUNDRED],
];
...
class AbstractInt extends _util.BN {
  ...
  constructor(registry) {
    ...
    super(
      ...
      (0, _util.isU8a)(value)
        ? bitLength <= 48
          ? (0, _util.u8aToNumber)(value.subarray(0, bitLength / 8), {
              isNegative: isSigned,
            })
  ...
  eq(other) {
    ...
    return super.eq(
      (0, _util.isHex)(other)
        ? (0, _util.hexToBn)(other.toString(), {
            isLe: false,
