...
class Enum {
  ...
  constructor(registry, Types, value, index) {
    ...
    const decoded =
      (0, _util.isU8a)(value) && value.length && !(0, _util.isNumber)(index)
  ...
  toU8a(isBare) {
    return isBare
      ...
      : (0, _util.u8aConcatStrict)([new Uint8Array([this.index]), this.#raw.toU8a(isBare)]);
  }
}
exports.Enum = Enum;
