 ...
 */
export declare function decodeU8a<T extends Codec = Codec>(
  registry: Registry,
  result: T[],
  u8a: Uint8Array,
  [Types, keys]: [CodecClass<T>[], string[]]
): [T[], number];
/**
 * @internal
 *
 ...
 */
export declare function decodeU8aStruct(
  registry: Registry,
  result: [string, Codec][],
  u8a: Uint8Array,
  [Types, keys]: [CodecClass[], string[]]
): [[string, Codec][], number];
/**
 * @internal
 *
 ...
 * is all on the hot-path, so it is not great, however there is (some) method behind the madness
 */
export declare function decodeU8aVec<T extends Codec = Codec>(
  registry: Registry,
  result: unknown[],
  u8a: Uint8Array,
  startAt: number,
