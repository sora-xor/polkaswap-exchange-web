...
function createKeyMulti(who, threshold) {
  return (0, asU8a_js_1.blake2AsU8a)(
    (0, util_1.u8aConcat)(
      PREFIX,
      (0, util_1.compactToU8a)(who.length),
      ...(0, util_1.u8aSorted)(who.map(util_js_1.addressToU8a)),
      (0, util_1.bnToU8a)(threshold, bn_js_1.BN_LE_16_OPTS)
    )
  );
}
