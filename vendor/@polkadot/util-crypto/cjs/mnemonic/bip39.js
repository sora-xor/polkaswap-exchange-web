...
function deriveChecksumBits(entropyBuffer) {
  return bytesToBinary(Array.from((0, index_js_3.sha256AsU8a)(entropyBuffer))).slice(
    0,
...
function mnemonicToSeedSync(mnemonic, password, rounds) {
  return (0, index_js_1.pbkdf2Encode)(
    (0, util_1.stringToU8a)(normalize(mnemonic)),
    (0, util_1.stringToU8a)(`mnemonic${normalize(password)}`),
    rounds
  ).password;
}
