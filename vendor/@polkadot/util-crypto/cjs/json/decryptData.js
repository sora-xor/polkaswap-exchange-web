...
function jsonDecryptData(encrypted, passphrase, encType = constants_js_1.ENCODING) {
  ...
  if (passphrase) {
    ...
    encoded = (0, index_js_1.naclDecrypt)(
      encrypted.subarray(constants_js_1.NONCE_LENGTH),
      encrypted.subarray(0, constants_js_1.NONCE_LENGTH),
      (0, util_1.u8aFixLength)(password, 256, true)
    );
  }
  if (!encoded) {
