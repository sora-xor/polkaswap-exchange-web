...
const SignedBlock_004_immortal_json_1 = tslib_1.__importDefault(
  require('@polkadot/types-support/json/SignedBlock.004.immortal.json')
);
...
const SUBSCRIPTIONS = Array.prototype.concat.apply(
  [],
  Object.values(jsonrpc_1.default).map((section) =>
...
class MockProvider {
  ...
  requests = {
    ...
    chain_getBlock: () =>
      this.registry.createType('SignedBlock', SignedBlock_004_immortal_json_1.default.result).toJSON(),
