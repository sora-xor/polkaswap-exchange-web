...
function createPair(_ref, _ref2) {
  let { toSS58, type } = _ref;
  let { publicKey, secretKey } = _ref2;
  ...
  return {
    ...
    decryptMessage: (encryptedMessageWithNonce, senderPublicKey) => {
      ...
      return (0, _utilCrypto.naclOpen)(
        messageU8a.slice(24, messageU8a.length),
        messageU8a.slice(0, 24),
        (0, _utilCrypto.convertPublicKeyToCurve25519)((0, _util.u8aToU8a)(senderPublicKey)),
        (0, _utilCrypto.convertSecretKeyToCurve25519)(secretKey)
      );
    },
    derive: (suri, meta) => {
      if (type === 'ethereum') {
    ...
    encryptMessage: (message, recipientPublicKey, nonceIn) => {
      ...
      const { nonce, sealed } = (0, _utilCrypto.naclSeal)(
        (0, _util.u8aToU8a)(message),
        (0, _utilCrypto.convertSecretKeyToCurve25519)(secretKey),
        (0, _utilCrypto.convertPublicKeyToCurve25519)((0, _util.u8aToU8a)(recipientPublicKey)),
        nonceIn
      );
    ...
    sign: function (message) {
      ...
      return (0, _util.u8aConcat)(
        ...
        TYPE_SIGNATURE[type]((0, _util.u8aToU8a)(message), {
          publicKey,
          secretKey,
        })
      );
    ...
    toJson: (passphrase) => {
      ...
      const address = ['ecdsa', 'ethereum'].includes(type)
        ? publicKey.length === 20
          ? (0, _util.u8aToHex)(publicKey)
          : (0, _util.u8aToHex)((0, _utilCrypto.secp256k1Compress)(publicKey))
        : encodeAddress();
      return (0, _toJson.pairToJson)(
        type,
        {
          address,
          meta,
    ...
    verify: (message, signature, signerPublic) => {
      return (0, _utilCrypto.signatureVerify)(message, signature, TYPE_ADDRESS[type]((0, _util.u8aToU8a)(signerPublic)))
        .isValid;
    },
    vrfSign: (message, context, extra) => {
      ...
      if (type === 'sr25519') {
        return (0, _utilCrypto.sr25519VrfSign)(
          message,
          {
            secretKey,
          },
    ...
    vrfVerify: (message, vrfResult, signerPublic, context, extra) => {
      ...
      const result = (0, _utilCrypto.signatureVerify)(
        message,
        (0, _util.u8aConcat)(TYPE_PREFIX[type], vrfResult.subarray(32)),
        TYPE_ADDRESS[type]((0, _util.u8aToU8a)(signerPublic))
      );
      return (
        result.isValid && (0, _util.u8aEq)(vrfResult.subarray(0, 32), vrfHash(vrfResult.subarray(32), context, extra))
      );
    },
  };
}
