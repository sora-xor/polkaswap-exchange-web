...
import {
  ...
  secp256k1PairFromSeed as secp256k1FromSeed,
  sr25519PairFromSeed as sr25519FromSeed,
  ...
  createFromUri(_suri, meta = {}, type = this.type) {
    ...
    if (isPhraseHex) {
      ...
      if ([12, 15, 18, 21, 24].includes(parts.length)) {
        seed =
          type === 'ethereum' ? mnemonicToLegacySeed(phrase, '', false, 64) : mnemonicToMiniSecret(phrase, password);
      } else {
        if (phrase.length > 32) {
