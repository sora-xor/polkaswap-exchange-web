(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
        factory((global.polkadotKeyring = {}), global.polkadotUtil, global.polkadotUtilCrypto));
  ...
  function createPair({ toSS58, type }, { publicKey, secretKey }, meta = {}, encoded = null, encTypes) {
    ...
    return {
      ...
      decryptMessage: (encryptedMessageWithNonce, senderPublicKey) => {
        ...
        return utilCrypto.naclOpen(
          messageU8a.slice(24, messageU8a.length),
          messageU8a.slice(0, 24),
          utilCrypto.convertPublicKeyToCurve25519(util.u8aToU8a(senderPublicKey)),
          utilCrypto.convertSecretKeyToCurve25519(secretKey)
        );
      },
      derive: (suri, meta) => {
        if (type === 'ethereum') {
      ...
      encryptMessage: (message, recipientPublicKey, nonceIn) => {
        ...
        const { nonce, sealed } = utilCrypto.naclSeal(
          util.u8aToU8a(message),
          utilCrypto.convertSecretKeyToCurve25519(secretKey),
          utilCrypto.convertPublicKeyToCurve25519(util.u8aToU8a(recipientPublicKey)),
          nonceIn
        );
      ...
      sign: (message, options = {}) => {
        ...
        return util.u8aConcat(
          ...
          TYPE_SIGNATURE[type](util.u8aToU8a(message), {
            publicKey,
            secretKey,
          })
        );
      ...
      vrfSign: (message, context, extra) => {
        ...
        if (type === 'sr25519') {
          return utilCrypto.sr25519VrfSign(
            message,
            {
              secretKey,
            },
      ...
      vrfVerify: (message, vrfResult, signerPublic, context, extra) => {
        ...
        const result = utilCrypto.signatureVerify(
          message,
          util.u8aConcat(TYPE_PREFIX[type], vrfResult.subarray(32)),
  ...
  class Pairs {
    ...
    get(address) {
      ...
      if (!pair) {
        throw new Error(
          `Unable to retrieve keypair '${util.isU8a(address) || util.isHex(address) ? util.u8aToHex(util.u8aToU8a(address)) : address}'`
        );
      }
      return pair;
    }
  ...
  class Keyring {
    ...
    constructor(options = {}) {
      ...
      if (!['ecdsa', 'ethereum', 'ed25519', 'sr25519'].includes(options.type || 'undefined')) {
        throw new Error(
          `Expected a keyring type of either 'ed25519', 'sr25519', 'ethereum' or 'ecdsa', found '${options.type || 'unknown'}`
        );
      }
          ...
          typeof document === 'undefined' && typeof location === 'undefined'
            ...
            : typeof document === 'undefined'
              ...
              : (document.currentScript && document.currentScript.src) ||
                new URL('bundle-polkadot-keyring.js', document.baseURI).href,
      } &&
      (typeof document === 'undefined' && typeof location === 'undefined'
        ? new (require('u' + 'rl').URL)('file:' + __filename).href
        : typeof document === 'undefined'
