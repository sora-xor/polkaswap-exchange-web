...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    alliance: {
       ...
       **/
      addUnscrupulousItems: AugmentedSubmittable<
        (
          items:
            | Vec<PalletAllianceUnscrupulousItem>
            | (
                | PalletAllianceUnscrupulousItem
                | {
                    AccountId: any;
       ...
       **/
      elevateAlly: AugmentedSubmittable<
        (
          ally:
            | MultiAddress
            | {
       ...
       **/
      initMembers: AugmentedSubmittable<
        (
          fellows: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[],
          allies: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[]
        ) => SubmittableExtrinsic<ApiType>,
       ...
       **/
      kickMember: AugmentedSubmittable<
        (
          who:
            | MultiAddress
            | {
       ...
       **/
      nominateAlly: AugmentedSubmittable<
        (
          who:
            | MultiAddress
            | {
       ...
       **/
      removeUnscrupulousItems: AugmentedSubmittable<
        (
          items:
            | Vec<PalletAllianceUnscrupulousItem>
            | (
    ...
    assets: {
      ...
      forceAssetStatus: AugmentedSubmittable<
        ...
        [Compact<u32>, MultiAddress, MultiAddress, MultiAddress, MultiAddress, Compact<u128>, bool, bool]
      >;
      /**
       * Cancel all of some asset approved for delegated transfer by a third-party account.
       *
    ...
    contracts: {
      ...
      uploadCode: AugmentedSubmittable<
        (
          code: Bytes | string | Uint8Array,
          storageDepositLimit: Option<Compact<u128>> | null | Uint8Array | Compact<u128> | AnyNumber,
          determinism: PalletContractsWasmDeterminism | 'Deterministic' | 'AllowIndeterminism' | number | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
    ...
    messageQueue: {
      ...
      executeOverweight: AugmentedSubmittable<
        ...
        [PalletMessageQueueMockHelpersMessageOrigin, u32, u32, SpWeightsWeightV2Weight]
      >;
      /**
    ...
    nfts: {
      ...
      clearAllTransferApprovals: AugmentedSubmittable<
        (collection: u32 | AnyNumber | Uint8Array, item: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32, u32]
      >;
      /**
      ...
      forceSetAttribute: AugmentedSubmittable<
        ...
        [Option<AccountId32>, u32, Option<u32>, FrameSupportTokensMiscAttributeNamespace, Bytes, Bytes]
      >;
      /**
      ...
      setAttribute: AugmentedSubmittable<
        ...
        [u32, Option<u32>, FrameSupportTokensMiscAttributeNamespace, Bytes, Bytes]
      >;
      /**
      ...
      setCollectionMetadata: AugmentedSubmittable<
        (collection: u32 | AnyNumber | Uint8Array, data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32, Bytes]
      >;
      /**
    ...
    nis: {
       ...
       **/
      communify: AugmentedSubmittable<
       ...
       **/
      privatize: AugmentedSubmittable<
        (index: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [Compact<u32>]
      >;
      /**
       ...
       **/
      thawCommunal: AugmentedSubmittable<
        (index: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [Compact<u32>]
      >;
      /**
       ...
       **/
      thawPrivate: AugmentedSubmittable<
        (
          index: Compact<u32> | AnyNumber | Uint8Array,
          maybeProportion: Option<Perquintill> | null | Uint8Array | Perquintill | AnyNumber
        ) => SubmittableExtrinsic<ApiType>,
        [Compact<u32>, Option<Perquintill>]
      >;
      /**
       * Generic tx
       **/
    ...
    nominationPools: {
       ...
       **/
      setMetadata: AugmentedSubmittable<
        (poolId: u32 | AnyNumber | Uint8Array, metadata: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32, Bytes]
      >;
      /**
    ...
    proxy: {
      ...
      addProxy: AugmentedSubmittable<
        ...
        [MultiAddress, KitchensinkRuntimeProxyType, u32]
      >;
      /**
      ...
      createPure: AugmentedSubmittable<
        ...
        [KitchensinkRuntimeProxyType, u32, u16]
      >;
      /**
      ...
      killPure: AugmentedSubmittable<
        ...
        [MultiAddress, KitchensinkRuntimeProxyType, u16, Compact<u32>, Compact<u32>]
      >;
      /**
      ...
      proxy: AugmentedSubmittable<
        (
          real:
            ...
            | Uint8Array,
          forceProxyType:
            | Option<KitchensinkRuntimeProxyType>
            | null
            | Uint8Array
            | KitchensinkRuntimeProxyType
            | 'Any'
        ...
        [MultiAddress, Option<KitchensinkRuntimeProxyType>, Call]
      >;
      /**
      ...
      proxyAnnounced: AugmentedSubmittable<
        ...
        [MultiAddress, MultiAddress, Option<KitchensinkRuntimeProxyType>, Call]
      >;
      /**
    ...
    rankedCollective: {
      ...
      cleanupPoll: AugmentedSubmittable<
        (pollIndex: u32 | AnyNumber | Uint8Array, max: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32, u32]
      >;
      /**
    ...
    rankedPolls: {
      ...
      submit: AugmentedSubmittable<
        ...
        [KitchensinkRuntimeOriginCaller, FrameSupportPreimagesBounded, FrameSupportScheduleDispatchTime]
      >;
      /**
       * Generic tx
       **/
    ...
    session: {
      ...
      setKeys: AugmentedSubmittable<
        ...
        [KitchensinkRuntimeSessionKeys, Bytes]
      >;
      /**
       * Generic tx
       **/
    ...
    transactionStorage: {
      ...
      renew: AugmentedSubmittable<
        (block: u32 | AnyNumber | Uint8Array, index: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32, u32]
      >;
      /**
    ...
    utility: {
      ...
      dispatchAs: AugmentedSubmittable<
        ...
        [KitchensinkRuntimeOriginCaller, Call]
      >;
      /**
       * Send a batch of dispatch calls.
