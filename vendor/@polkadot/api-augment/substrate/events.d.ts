...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    alliance: {
       ...
       **/
      AllianceDisbanded: AugmentedEvent<
        ApiType,
        [fellowMembers: u32, allyMembers: u32, unreserved: u32],
        {
          fellowMembers: u32;
          allyMembers: u32;
          unreserved: u32;
       ...
       **/
      AnnouncementRemoved: AugmentedEvent<
        ApiType,
        [announcement: PalletAllianceCid],
        {
          announcement: PalletAllianceCid;
       ...
       **/
      FellowAbdicated: AugmentedEvent<
        ApiType,
        [fellow: AccountId32],
        {
          fellow: AccountId32;
      ...
      MemberKicked: AugmentedEvent<
        ApiType,
        [member: AccountId32, slashed: Option<u128>],
        {
          member: AccountId32;
          slashed: Option<u128>;
        }
       ...
       **/
      MemberRetired: AugmentedEvent<
        ApiType,
        [member: AccountId32, unreserved: Option<u128>],
        {
          member: AccountId32;
       ...
       **/
      MemberRetirementPeriodStarted: AugmentedEvent<
        ApiType,
        [member: AccountId32],
        {
          member: AccountId32;
       ...
       **/
      MembersInitialized: AugmentedEvent<
        ApiType,
        [fellows: Vec<AccountId32>, allies: Vec<AccountId32>],
        {
       ...
       **/
      NewAllyJoined: AugmentedEvent<
        ApiType,
        [ally: AccountId32, nominator: Option<AccountId32>, reserved: Option<u128>],
        {
          ally: AccountId32;
       ...
       **/
      UnscrupulousItemAdded: AugmentedEvent<
        ApiType,
       ...
       **/
      UnscrupulousItemRemoved: AugmentedEvent<
        ApiType,
        [items: Vec<PalletAllianceUnscrupulousItem>],
        {
          items: Vec<PalletAllianceUnscrupulousItem>;
    ...
    assets: {
      ...
      ApprovedTransfer: AugmentedEvent<
        ApiType,
        [assetId: u32, source: AccountId32, delegate: AccountId32, amount: u128],
        {
          assetId: u32;
          source: AccountId32;
          delegate: AccountId32;
      ...
      TransferredApproved: AugmentedEvent<
        ApiType,
        [assetId: u32, owner: AccountId32, delegate: AccountId32, destination: AccountId32, amount: u128],
        {
          assetId: u32;
          owner: AccountId32;
          delegate: AccountId32;
    ...
    assetTxPayment: {
       ...
       **/
      AssetTxFeePaid: AugmentedEvent<
        ApiType,
        [who: AccountId32, actualFee: u128, tip: u128, assetId: Option<u32>],
        {
          who: AccountId32;
          actualFee: u128;
          tip: u128;
    ...
    lottery: {
       ...
       **/
      TicketBought: AugmentedEvent<
        ApiType,
        [who: AccountId32, callIndex: ITuple<[u8, u8]>],
        {
          who: AccountId32;
      ...
      Winner: AugmentedEvent<
        ApiType,
        [winner: AccountId32, lotteryBalance: u128],
        {
          winner: AccountId32;
          lotteryBalance: u128;
        }
    ...
    messageQueue: {
      ...
      OverweightEnqueued: AugmentedEvent<
        ApiType,
        [hash_: H256, origin: PalletMessageQueueMockHelpersMessageOrigin, pageIndex: u32, messageIndex: u32],
        {
          hash_: H256;
      ...
      PageReaped: AugmentedEvent<
        ApiType,
        [origin: PalletMessageQueueMockHelpersMessageOrigin, index: u32],
        {
          origin: PalletMessageQueueMockHelpersMessageOrigin;
          index: u32;
        }
    ...
    nfts: {
      ...
      AttributeCleared: AugmentedEvent<
        ApiType,
        [collection: u32, maybeItem: Option<u32>, key: Bytes, namespace: FrameSupportTokensMiscAttributeNamespace],
        {
          collection: u32;
      ...
      TransferApproved: AugmentedEvent<
        ApiType,
        [collection: u32, item: u32, owner: AccountId32, delegate: AccountId32, deadline: Option<u32>],
        {
          collection: u32;
          item: u32;
          owner: AccountId32;
    ...
    nis: {
      ...
      Issued: AugmentedEvent<
        ApiType,
        [index: u32, expiry: u32, who: AccountId32, proportion: Perquintill, amount: u128],
        {
          index: u32;
          expiry: u32;
          who: AccountId32;
      ...
      Thawed: AugmentedEvent<
        ApiType,
        [index: u32, who: AccountId32, proportion: Perquintill, amount: u128, dropped: bool],
        {
          index: u32;
          who: AccountId32;
          proportion: Perquintill;
      ...
      Transferred: AugmentedEvent<
        ApiType,
        [from: AccountId32, to: AccountId32, index: u32],
        {
          from: AccountId32;
          to: AccountId32;
          index: u32;
    ...
    proxy: {
      ...
      ProxyAdded: AugmentedEvent<
        ApiType,
        [delegator: AccountId32, delegatee: AccountId32, proxyType: KitchensinkRuntimeProxyType, delay: u32],
        {
      ...
      PureCreated: AugmentedEvent<
        ApiType,
        [pure: AccountId32, who: AccountId32, proxyType: KitchensinkRuntimeProxyType, disambiguationIndex: u16],
        {
          pure: AccountId32;
          who: AccountId32;
          proxyType: KitchensinkRuntimeProxyType;
    ...
    rankedCollective: {
      ...
      Voted: AugmentedEvent<
        ApiType,
        [who: AccountId32, poll: u32, vote: PalletRankedCollectiveVoteRecord, tally: PalletRankedCollectiveTally],
        {
          who: AccountId32;
          poll: u32;
    ...
    remark: {
      ...
      Stored: AugmentedEvent<
        ApiType,
        [sender: AccountId32, contentHash: H256],
        {
          sender: AccountId32;
          contentHash: H256;
        }
