...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    alliance: {
       ...
       **/
      announcements: AugmentedQuery<ApiType, () => Observable<Vec<PalletAllianceCid>>, []> &
      ...
      members: AugmentedQuery<
        ApiType,
        (
          arg: PalletAllianceMemberRole | 'Fellow' | 'Ally' | 'Retiring' | number | Uint8Array
        ) => Observable<Vec<AccountId32>>,
        [PalletAllianceMemberRole]
      > &
        QueryableStorageEntry<ApiType, [PalletAllianceMemberRole]>;
      /**
       ...
       **/
      retiringMembers: AugmentedQuery<
        ApiType,
       ...
       **/
      rule: AugmentedQuery<ApiType, () => Observable<Option<PalletAllianceCid>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * The current list of accounts deemed unscrupulous. These accounts non grata cannot submit
       * candidacy.
       **/
      unscrupulousAccounts: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * The current list of websites deemed unscrupulous.
       **/
      unscrupulousWebsites: AugmentedQuery<ApiType, () => Observable<Vec<Bytes>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    lottery: {
       ...
       **/
      participants: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<ITuple<[u32, Vec<ITuple<[u8, u8]>>]>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
    ...
    messageQueue: {
      ...
      bookStateFor: AugmentedQuery<
        ...
        [PalletMessageQueueMockHelpersMessageOrigin]
      > &
        QueryableStorageEntry<ApiType, [PalletMessageQueueMockHelpersMessageOrigin]>;
      /**
      ...
      pages: AugmentedQuery<
        ...
        [PalletMessageQueueMockHelpersMessageOrigin, u32]
      > &
        QueryableStorageEntry<ApiType, [PalletMessageQueueMockHelpersMessageOrigin, u32]>;
      /**
       * The origin at which we should begin servicing.
       **/
      serviceHead: AugmentedQuery<ApiType, () => Observable<Option<PalletMessageQueueMockHelpersMessageOrigin>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    nfts: {
      ...
      attribute: AugmentedQuery<
        ...
        [u32, Option<u32>, FrameSupportTokensMiscAttributeNamespace, Bytes]
      > &
        QueryableStorageEntry<ApiType, [u32, Option<u32>, FrameSupportTokensMiscAttributeNamespace, Bytes]>;
      /**
      ...
      collectionAccount: AugmentedQuery<
        ApiType,
        (arg1: AccountId32 | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<Option<Null>>,
        [AccountId32, u32]
      > &
      ...
      collectionRoleOf: AugmentedQuery<
        ApiType,
        (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<u8>>,
        [u32, AccountId32]
      > &
        QueryableStorageEntry<ApiType, [u32, AccountId32]>;
      /**
      ...
      itemAttributesApprovalsOf: AugmentedQuery<
        ApiType,
        (arg1: u32 | AnyNumber | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<BTreeSet<AccountId32>>,
        [u32, u32]
      > &
        QueryableStorageEntry<ApiType, [u32, u32]>;
      /**
    ...
    pov: {
      ...
      doubleMap1M: AugmentedQuery<
        ApiType,
        (arg1: u32 | AnyNumber | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<Option<u32>>,
        [u32, u32]
      > &
        QueryableStorageEntry<ApiType, [u32, u32]>;
      /**
       ...
       **/
      map16M: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u32>>, [u32]> &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       * A map with a maximum of 1M entries.
       **/
      map1M: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u32>>, [u32]> &
        QueryableStorageEntry<ApiType, [u32]>;
      unboundedMap: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<Vec<u32>>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      unboundedMap2: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<Vec<u32>>>,
        [u32]
      > &
    ...
    session: {
      ...
      nextKeys: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<Option<KitchensinkRuntimeSessionKeys>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
      ...
      queuedKeys: AugmentedQuery<
        ApiType,
        () => Observable<Vec<ITuple<[AccountId32, KitchensinkRuntimeSessionKeys]>>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      /**
    ...
    transactionStorage: {
      blockTransactions: AugmentedQuery<ApiType, () => Observable<Vec<PalletTransactionStorageTransactionInfo>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      chunkCount: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<u32>, [u32]> &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
      ...
      transactions: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<Vec<PalletTransactionStorageTransactionInfo>>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
