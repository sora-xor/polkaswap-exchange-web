...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    crowdloan: {
       ...
       **/
      AddedToNewRaise: AugmentedEvent<
        ApiType,
        [paraId: u32],
        {
          paraId: u32;
    ...
    proxy: {
      ...
      ProxyAdded: AugmentedEvent<
        ApiType,
        [delegator: AccountId32, delegatee: AccountId32, proxyType: KusamaRuntimeProxyType, delay: u32],
        {
      ...
      PureCreated: AugmentedEvent<
        ApiType,
        [pure: AccountId32, who: AccountId32, proxyType: KusamaRuntimeProxyType, disambiguationIndex: u16],
        {
          pure: AccountId32;
          who: AccountId32;
          proxyType: KusamaRuntimeProxyType;
    ...
    slots: {
      ...
      Leased: AugmentedEvent<
        ApiType,
        [paraId: u32, leaser: AccountId32, periodBegin: u32, periodCount: u32, extraReserved: u128, totalAmount: u128],
        {
          paraId: u32;
          leaser: AccountId32;
          periodBegin: u32;
