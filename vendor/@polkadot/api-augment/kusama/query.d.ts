...
import type {
  ...
  PolkadotPrimitivesV2AssignmentAppPublic,
  ...
  PolkadotPrimitivesVstagingExecutorParams,
  ...
  interface AugmentedQueries<ApiType extends ApiTypes> {
    auctions: {
      ...
      winning: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<Vec<Option<ITuple<[AccountId32, u32, u128]>>>>>,
        [u32]
      > &
    ...
    claims: {
      ...
      signing: AugmentedQuery<
        ApiType,
        (arg: EthereumAddress | string | Uint8Array) => Observable<Option<PolkadotRuntimeCommonClaimsStatementKind>>,
        [EthereumAddress]
      > &
        QueryableStorageEntry<ApiType, [EthereumAddress]>;
      ...
      vesting: AugmentedQuery<
        ApiType,
        (arg: EthereumAddress | string | Uint8Array) => Observable<Option<ITuple<[u128, u128, u32]>>>,
        [EthereumAddress]
      > &
        QueryableStorageEntry<ApiType, [EthereumAddress]>;
      /**
    ...
    crowdloan: {
      ...
      funds: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PolkadotRuntimeCommonCrowdloanFundInfo>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    fellowshipCollective: {
      ...
      idToIndex: AugmentedQuery<
        ApiType,
        (arg1: u16 | AnyNumber | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<u32>>,
        [u16, AccountId32]
      > &
      ...
      indexToId: AugmentedQuery<
        ApiType,
        (arg1: u16 | AnyNumber | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<Option<AccountId32>>,
        [u16, u32]
      > &
      ...
      votingCleanup: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<Bytes>>, [u32]> &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
    ...
    fellowshipReferenda: {
       ...
       * large preimages.
       **/
      metadataOf: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<H256>>, [u32]> &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       * The next free referendum index, aka the number of referenda started so far.
       **/
      ...
      referendumInfoFor: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletReferendaReferendumInfoRankedCollectiveTally>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    hrmp: {
       ...
       **/
      hrmpWatermarks: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u32>>, [u32]> &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
    ...
    nis: {
       ...
       **/
      queues: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<PalletNisBid>>, [u32]> &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      receipts: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletNisReceiptRecord>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      summary: AugmentedQuery<ApiType, () => Observable<PalletNisSummaryRecord>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    paraInclusion: {
      ...
      pendingAvailabilityCommitments: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PolkadotPrimitivesV2CandidateCommitments>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    paraInherent: {
       ...
       **/
      onChainVotes: AugmentedQuery<ApiType, () => Observable<Option<PolkadotPrimitivesV2ScrapedOnChainVotes>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    paras: {
       ...
       * [`PastCodeHash`].
       **/
      codeByHash: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<Bytes>>, [H256]> &
        QueryableStorageEntry<ApiType, [H256]>;
      /**
       ...
       **/
      currentCodeHash: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<H256>>, [u32]> &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       * Corresponding code can be retrieved with [`CodeByHash`].
       **/
      futureCodeHash: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<H256>>, [u32]> &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
      ...
      pvfActiveVoteMap: AugmentedQuery<
        ApiType,
        (arg: H256 | string | Uint8Array) => Observable<Option<PolkadotRuntimeParachainsParasPvfCheckActiveVoteState>>,
        [H256]
      > &
        QueryableStorageEntry<ApiType, [H256]>;
      /**
      ...
      upcomingParasGenesis: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PolkadotRuntimeParachainsParasParaGenesisArgs>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
      ...
      upgradeGoAheadSignal: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PolkadotPrimitivesV2UpgradeGoAhead>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
      ...
      upgradeRestrictionSignal: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PolkadotPrimitivesV2UpgradeRestriction>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    paraScheduler: {
       ...
       **/
      availabilityCores: AugmentedQuery<ApiType, () => Observable<Vec<Option<PolkadotPrimitivesV2CoreOccupied>>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      scheduled: AugmentedQuery<ApiType, () => Observable<Vec<PolkadotRuntimeParachainsSchedulerCoreAssignment>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
    ...
    parasDisputes: {
      ...
      backersOnDisputes: AugmentedQuery<
        ApiType,
        (arg1: u32 | AnyNumber | Uint8Array, arg2: H256 | string | Uint8Array) => Observable<Option<BTreeSet<u32>>>,
        [u32, H256]
      > &
    ...
    paraSessionInfo: {
      ...
      sessionExecutorParams: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PolkadotPrimitivesVstagingExecutorParams>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    parasShared: {
       ...
       **/
      activeValidatorKeys: AugmentedQuery<ApiType, () => Observable<Vec<PolkadotPrimitivesV2ValidatorAppPublic>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
    ...
    referenda: {
      ...
      referendumInfoFor: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletReferendaReferendumInfoConvictionVotingTally>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    registrar: {
       ...
       **/
      pendingSwap: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u32>>, [u32]> &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
    ...
    session: {
      ...
      nextKeys: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<Option<KusamaRuntimeSessionKeys>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, KusamaRuntimeSessionKeys]>>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
    ...
    whitelist: {
      whitelistedCall: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<Null>>, [H256]> &
        QueryableStorageEntry<ApiType, [H256]>;
      /**
       * Generic query
       **/
