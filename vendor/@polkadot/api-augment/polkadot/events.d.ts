  ...
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    proxy: {
      ...
      ProxyAdded: AugmentedEvent<
        ApiType,
        [delegator: AccountId32, delegatee: AccountId32, proxyType: PolkadotRuntimeProxyType, delay: u32],
        {
      ...
      PureCreated: AugmentedEvent<
        ApiType,
        [pure: AccountId32, who: AccountId32, proxyType: PolkadotRuntimeProxyType, disambiguationIndex: u16],
        {
          pure: AccountId32;
          who: AccountId32;
          proxyType: PolkadotRuntimeProxyType;
