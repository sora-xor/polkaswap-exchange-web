...
type CodecReturnType<T extends (...args: unknown[]) => Observable<Codec>> = T extends (...args: any) => infer R
 ...
 */
export declare function toPromiseMethod<M extends DecorateFn<CodecReturnType<M>>>(
  method: M,
