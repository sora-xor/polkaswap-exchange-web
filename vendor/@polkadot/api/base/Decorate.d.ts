...
export declare abstract class Decorate<ApiType extends ApiTypes> extends Events {
  ...
  protected _createDecorated(
    registry: VersionedRegistry<ApiType>,
    fromEmpty: boolean,
  ...
  protected _decorateRpc<ApiType extends ApiTypes>(
  ...
  protected _getRuntimeDefs(
    registry: Registry,
    specName: Text,
    chain?: Text | string
  ): [string, DefinitionsCallEntry[]][];
  protected _decorateCalls<ApiType extends ApiTypes>(
    {
      registry,
      runtimeVersion: { apis, specName, specVersion },
    }: VersionedRegistry<any>,
    decorateMethod: DecorateMethod<ApiType>,
    blockHash?: Uint8Array | string | null
  ): QueryableCalls<ApiType>;
  protected _decorateCall<ApiType extends ApiTypes>(
    registry: Registry,
    def: DefinitionCallNamed,
    stateCall: (method: string, bytes: Uint8Array) => Observable<Codec>,
    decorateMethod: DecorateMethod<ApiType>
  ): AugmentedCall<ApiType>;
  protected _decorateMulti<ApiType extends ApiTypes>(
    decorateMethod: DecorateMethod<ApiType>
  ): QueryableStorageMulti<ApiType>;
  protected _decorateMultiAt<ApiType extends ApiTypes>(
    atApi: ApiDecoration<ApiType>,
    decorateMethod: DecorateMethod<ApiType>,
    blockHash: Uint8Array | string
  ): QueryableStorageMulti<ApiType>;
  protected _decorateExtrinsics<ApiType extends ApiTypes>(
    { tx }: DecoratedMeta,
    decorateMethod: DecorateMethod<ApiType>
  ): SubmittableExtrinsics<ApiType>;
  private _decorateExtrinsicEntry;
  protected _decorateStorage<ApiType extends ApiTypes>(
    { query, registry }: DecoratedMeta,
    decorateMethod: DecorateMethod<ApiType>,
    blockHash?: Uint8Array
