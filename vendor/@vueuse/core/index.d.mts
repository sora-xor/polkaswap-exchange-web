...
declare function computedInject<T, K = any>(
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function createReusableTemplate<
  Bindings extends Record<string, any>,
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function createTemplatePromise<Return, Args extends any[] = []>(
  options?: TemplatePromiseOptions
...
type UnRefElementReturn<T extends MaybeElement = MaybeElement> = T extends VueInstance
 ...
 * @param options
 */
declare function onClickOutside<T extends OnClickOutsideOptions>(
  target: MaybeElementRef,
  handler: OnClickOutsideHandler<T>,
  options?: T
): Fn;
declare function onClickOutside<T extends OnClickOutsideOptions<true>>(
  target: MaybeElementRef,
  handler: OnClickOutsideHandler<T>,
  options: T
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function templateRef<T extends HTMLElement | SVGElement | Component | null, Keys extends string = string>(
  key: Keys,
  initialValue?: T | null
): Readonly<Ref<T>>;
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function useActiveElement<T extends HTMLElement>(
  options?: UseActiveElementOptions
): vue.ShallowRef<T | null | undefined, T | null | undefined>;
 ...
 * @param options
 */
declare function useAsyncQueue<T extends any[], S = MapQueueTask<T>>(
...
type UseAsyncStateReturn<Data, Params extends any[], Shallow extends boolean> = UseAsyncStateReturnBase<
  Data,
  Params,
  Shallow
> &
 ...
 * @param options
 */
declare function useAsyncState<Data, Params extends any[] = any[], Shallow extends boolean = true>(
...
declare function useBase64<T extends Record<string, unknown>>(
  target: MaybeRefOrGetter<T>,
  options?: UseBase64ObjectOptions<T>
): UseBase64Return;
declare function useBase64<T extends Map<string, unknown>>(
  target: MaybeRefOrGetter<T>,
  options?: UseBase64ObjectOptions<T>
): UseBase64Return;
declare function useBase64<T extends Set<unknown>>(
  target: MaybeRefOrGetter<T>,
  options?: UseBase64ObjectOptions<T>
): UseBase64Return;
...
): Record<K, vue.ComputedRef<boolean>> & {
...
declare function useCached<T, D extends boolean = true>(
  refValue: Ref<T>,
...
declare function useClipboardItems(
...
declare function getSSRHandler<T extends keyof SSRHandlersMap>(
  key: T,
...
declare const StorageSerializers: Record<
...
declare function useStorage<T>(
  key: MaybeRefOrGetter<string>,
  defaults: MaybeRefOrGetter<T>,
  storage?: StorageLike,
  options?: UseStorageOptions<T>
): RemovableRef<T>;
declare function useStorage<T = unknown>(
  key: MaybeRefOrGetter<string>,
 ...
 * @param options
 */
declare function useColorMode<T extends string = BasicColorMode>(
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function useConfirmDialog<RevealData = any, ConfirmData = any, CancelData = any>(
 ...
 * @param options
 */
declare function useCssVar(
  prop: MaybeRefOrGetter<string | null | undefined>,
  target?: MaybeElementRef,
  options?: UseCssVarOptions
): vue.ShallowRef<string | undefined, string | undefined>;
...
>(rootComponent?: MaybeElementRef<R>): _vueuse_shared.ComputedRefWithControl<E>;
 ...
 * @param options
 */
declare function useManualRefHistory<Raw, Serialized = Raw>(
  source: Ref<Raw>,
 ...
 * @param options
 */
declare function useRefHistory<Raw, Serialized = Raw>(
  source: Ref<Raw>,
 ...
 * @param options
 */
declare function useDebouncedRefHistory<Raw, Serialized = Raw>(
  source: Ref<Raw>,
...
declare function useDisplayMedia(options?: UseDisplayMediaOptions): {
  ...
  stop: () => void;
  enabled:
    | vue.Ref<boolean, boolean>
    | vue.ShallowRef<boolean, boolean>
    | vue.WritableComputedRef<boolean, boolean>
    | vue.ShallowRef<false, false>
    | vue.ShallowRef<true, true>;
};
 ...
 */
declare function useElementByPoint<M extends boolean = false>(
...
declare function useElementHover(
 ...
 */
declare function useElementVisibility(
 ...
 * @see https://vueuse.org/useEventListener
 */
declare function useEventListener<E extends keyof ShadowRootEventMap>(
 ...
 * @see https://vueuse.org/useEventListener
 */
declare function useEventListener<E extends keyof HTMLElementEventMap>(
 ...
 * @param options
 */
declare function useEventSource<Events extends string[], Data = any>(
...
type UseFileSystemAccessOptions = ConfigurableWindow &
...
declare function useFileSystemAccess(
 ...
 */
declare function useImage<Shallow extends true>(
 ...
 */
declare function useInfiniteScroll<T extends InfiniteScrollElement>(
...
declare function useKeyModifier<Initial extends boolean | null>(
...
declare function useLocalStorage<T = unknown>(
  key: MaybeRefOrGetter<string>,
...
type UseMagicKeysReturn<Reactive extends boolean> = Readonly<
  Omit<
    Reactive extends true ? Record<string, boolean> : Record<string, ComputedRef<boolean>>,
...
declare function useMediaControls(
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function useMemoize<Result, Args extends unknown[]>(
 ...
 * @param object
 */
declare function useObjectUrl(
  object: MaybeRefOrGetter<Blob | MediaSource | null | undefined>
): Readonly<vue.Ref<string | undefined, string | undefined>>;
...
declare function useParentElement(
 ...
 * @param options
 */
declare function usePerformanceObserver(
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function usePointerLock(
  target?: MaybeElementRef,
 ...
 * @param options
 */
declare function usePointerSwipe(
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function usePreferredReducedTransparency(
  options?: ConfigurableWindow
): vue.ComputedRef<ReducedTransparencyType>;
...
declare function useSessionStorage<T = unknown>(
  key: MaybeRefOrGetter<string>,
  initialValue: MaybeRefOrGetter<null>,
  options?: UseStorageOptions<T>
): RemovableRef<T>;
...
declare function useSorted<T = any>(
 ...
 */
declare function useSpeechSynthesis(
...
declare function useStepper<T extends string | number>(
  steps: MaybeRef<T[]>,
  initialStep?: T
): UseStepperReturn<T, T[], T>;
declare function useStepper<T extends Record<string, any>>(
  steps: MaybeRef<T>,
  initialStep?: keyof T
...
declare function useStorageAsync(
  key: string,
  initialValue: MaybeRefOrGetter<string>,
...
declare function useStorageAsync<T>(
  key: string,
  initialValue: MaybeRefOrGetter<T>,
  storage?: StorageLikeAsync,
  options?: UseStorageAsyncOptions<T>
): RemovableRef<T> & Promise<RemovableRef<T>>;
declare function useStorageAsync<T = unknown>(
  key: string,
  initialValue: MaybeRefOrGetter<null>,
  storage?: StorageLikeAsync,
  options?: UseStorageAsyncOptions<T>
...
): vue.WritableComputedRef<UseTextDirectionValue, UseTextDirectionValue>;
...
type UseThrottledRefHistoryOptions<Raw, Serialized = Raw> = Omit<
 ...
 * @param options
 */
declare function useThrottledRefHistory<Raw, Serialized = Raw>(
  source: Ref<Raw>,
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function useTimeAgo<UnitNames extends string = UseTimeAgoUnitNamesDefault>(
  time: MaybeRefOrGetter<Date | number | string>,
  options?: UseTimeAgoOptions<false, UnitNames>
): UseTimeAgoReturn$1<false>;
declare function useTimeAgo<UnitNames extends string = UseTimeAgoUnitNamesDefault>(
  time: MaybeRefOrGetter<Date | number | string>,
  options: UseTimeAgoOptions<true, UnitNames>
): UseTimeAgoReturn$1<true>;
declare function formatTimeAgo<UnitNames extends string = UseTimeAgoUnitNamesDefault>(
  from: Date,
 ...
 */
declare function useTimeAgoIntl(
  time: MaybeRefOrGetter<Date | number | string>,
 ...
 */
declare function formatTimeAgoIntlParts(
  parts: Intl.RelativeTimeFormatPart[],
...
declare function useTimeoutPoll(
  fn: () => Awaitable<void>,
  interval: MaybeRefOrGetter<number>,
 ...
 * @param options
 */
declare function executeTransition<T extends number | number[]>(
  source: Ref<T>,
...
declare function useTransition<T extends MaybeRefOrGetter<number>[]>(
  source: [...T],
 ...
 * @param options
 */
declare function useUrlSearchParams<T extends Record<string, any> = UrlParams>(
 ...
 * @__NO_SIDE_EFFECTS__
 */
declare function useVModels<P extends object, Name extends string>(
  props: P,
  emit?: (name: Name, ...args: any[]) => void,
 ...
 */
declare function useVirtualList<T = any>(
 ...
 * @param url
 */
declare function useWebSocket<Data = any>(
  url: MaybeRefOrGetter<string | URL | undefined>,
 ...
 * @param options
 */
declare function useWebWorker<T = any>(
  url: string,
 ...
 * @param options
 */
declare function useWebWorkerFn<T extends (...fnArgs: any[]) => any>(
  fn: T,
...
export type {
  ...
  UseTimeAgoOptions,
  UseTimeAgoReturn$1 as UseTimeAgoReturn,
  UseTimeAgoUnit,
