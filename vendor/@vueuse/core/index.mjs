...
function useBreakpoints(breakpoints, options = {}) {
  ...
  function current() {
    const points = Object.keys(breakpoints)
      .map((k) => [k, shortcutMethods[k], pxValue(getValue(k))])
      .sort((a, b) => a[2] - b[2]);
...
function useElementByPoint(options) {
  ...
  const cb = () => {
    ...
    element.value = toValue(multiple)
      ? (_a = document == null ? void 0 : document.elementsFromPoint(toValue(x), toValue(y))) != null
        ? _a
        : []
      : (_b = document == null ? void 0 : document.elementFromPoint(toValue(x), toValue(y))) != null
        ? _b
        : null;
  };
  const controls =
...
function useTextDirection(options = {}) {
  ...
  function getValue() {
    var _a, _b;
    return (_b =
      (_a = document == null ? void 0 : document.querySelector(selector)) == null ? void 0 : _a.getAttribute('dir')) !=
      null
      ? _b
      : initialValue;
  }
