...
var functions$1 = [
  ...
  },
  {
    ...
    category: 'Browser',
    description:
      'reactive [Navigator Languages](https://developer.mozilla.org/en-US/docs/Web/API/NavigatorLanguage/languages)',
  },
  {
    name: 'useQRCode',
    package: 'integrations',
  ...
  },
  {
    ...
    related: ['useDebouncedRefHistory'],
  },
  {
