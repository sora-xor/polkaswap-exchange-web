    ...
    return vue.withDirectives(
      ...
      vue.createElementBlock(
        'div',
        {
          ...
          onScrollPassive:
            _cache[0] || (_cache[0] = (...args) => $options.handleScroll && $options.handleScroll(...args)),
        },
        [
          _ctx.$slots.before
            ? (vue.openBlock(),
              vue.createElementBlock('div', _hoisted_1, [vue.renderSlot(_ctx.$slots, 'before')], 512 /* NEED_PATCH */))
            : vue.createCommentVNode('v-if', true),
          (vue.openBlock(),
          vue.createBlock(
            vue.resolveDynamicComponent($props.listTag),
            {
              ref: 'wrapper',
            ...
            },
            {
              default: vue.withCtx(() => [
                ...
                vue.createElementBlock(
                  vue.Fragment,
                  null,
                  vue.renderList($data.pool, (view) => {
                    return (
                      vue.openBlock(),
                      vue.createBlock(
                        vue.resolveDynamicComponent($props.itemTag),
                        vue.mergeProps(
                          {
                            key: view.nr.id,
                            style: $data.ready
                              ? {
                                  ...
                                  width: $props.gridItems
                                    ? `${_ctx.direction === 'vertical' ? $props.itemSecondarySize || $props.itemSize : $props.itemSize}px`
                                    : undefined,
                                  height: $props.gridItems
                                    ? `${_ctx.direction === 'horizontal' ? $props.itemSecondarySize || $props.itemSize : $props.itemSize}px`
                                    : undefined,
                                }
                              : null,
                            class: [
          ...
          _ctx.$slots.after
            ? (vue.openBlock(),
              vue.createElementBlock('div', _hoisted_2, [vue.renderSlot(_ctx.$slots, 'after')], 512 /* NEED_PATCH */))
            : vue.createCommentVNode('v-if', true),
          vue.createVNode(_component_ResizeObserver, { onNotify: $options.handleResize }, null, 8 /* PROPS */, [
            'onNotify',
          ]),
        ],
    ...
    return (
      ...
      vue.createBlock(
        ...
        ),
        {
          ...
          before: vue.withCtx(() => [vue.renderSlot(_ctx.$slots, 'before')]),
          after: vue.withCtx(() => [vue.renderSlot(_ctx.$slots, 'after')]),
  ...
  var script = {
    ...
    computed: {
      id() {
        ...
        throw new Error(
          `keyField '${this.vscrollData.keyField}' not found in your item. You should set a valid keyField prop on your Scroller`
        );
      },
