...
var script$2 = {
  ...
  methods: {
    ...
    scrollToPosition(position) {
      const direction =
        this.direction === 'vertical' ? { scroll: 'scrollTop', start: 'top' } : { scroll: 'scrollLeft', start: 'left' };
  ...
  return withDirectives(
    ...
    createElementBlock(
      ...
      [
        _ctx.$slots.before
          ? (openBlock(),
            createElementBlock('div', _hoisted_1, [renderSlot(_ctx.$slots, 'before')], 512 /* NEED_PATCH */))
        ...
        _ctx.$slots.after
          ? (openBlock(),
            createElementBlock('div', _hoisted_2, [renderSlot(_ctx.$slots, 'after')], 512 /* NEED_PATCH */))
          : createCommentVNode('v-if', true),
