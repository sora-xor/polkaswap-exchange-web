...
<RecycleScroller>
  ...
  <wrapper :style="{ height: computedTotalHeight + 'px' }">
    ...
    <view v-for="view of pool" :style="{ transform: 'translateY(' + view.computedTop + 'px)' }">
...
```html
<RecycleScroller :items="items" :item-size="42" :prerender="10"></RecycleScroller>
```
...
<template>
  <div class="question">
    ...
    <textarea v-if="idState.replyOpen" v-model="idState.replyText" placeholder="Type your reply" />
  </div>
</template>
