...
!(function (t, e) {
      ...
      for (var l = [], u = Array.from(e); u.length; ) {
        ...
        if (!a(d, !1))
          if ('SLOT' === d.tagName) {
            ...
            i.flatten ? l.push.apply(l, f) : l.push({ scopeParent: d, candidates: f });
          } else {
            ...
            if (s && p) {
              ...
              i.flatten ? l.push.apply(l, h) : l.push({ scopeParent: d, candidates: h });
          ...
          (function (t) {
            ...
            if (a && a !== t)
              for (
                ...
                var d, c, f;
                u = !(
                  null === (c = l = null === (d = a = i(l)) || void 0 === d ? void 0 : d.host) ||
                  void 0 === c ||
        ...
        e.forEach(function (e, r) {
          ...
          0 === l
            ? i
              ? n.push.apply(n, u)
              : n.push(a)
            : o.push({ documentOrder: r, tabIndex: l, item: e, isScope: i, content: u });
        }),
        o
          .sort(f)
          .reduce(function (t, e) {
  ...
  ((t.focusable = function (t, e) {
    return (e = e || {}).getShadowRoot
      ? u([t], e.includeContainer, { filter: b.bind(null, e), flatten: !0, getShadowRoot: e.getShadowRoot })
